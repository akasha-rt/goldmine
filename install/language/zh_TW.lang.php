...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到數據庫支持。請確保您具有以下受支持的數據庫類型之一的必要驅動程序：MySQL、MS SQLServer、Oracle或DB2。您可能需要在php中取消註釋擴展。 ini文件，或使用正確的二進製文件重新編譯，具體取決於您的PHP版本。有關如何啟用數據庫支持的更多信息，請參閱您的PHP手冊。',
