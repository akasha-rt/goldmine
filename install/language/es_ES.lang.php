...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se encontró compatibilidad con la base de datos. Asegúrese de tener los controladores necesarios para uno de los siguientes tipos de bases de datos compatibles: MySQL, MS SQLServer, Oracle o DB2. Es posible que deba quitar la marca de comentario de la extensión en archivos php.ini, o recompile con el archivo binario correcto, dependiendo de su versión de PHP. Consulte su manual de PHP para obtener más información sobre cómo habilitar la compatibilidad con la base de datos.',
