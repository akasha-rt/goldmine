...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Il supporto del database non è stato trovato.  Assicurarsi di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SqlServer, Oracle o DB2.  Potrebbe essere necessario rimuovere il commento dell\'estensione nel php.ini file, o ricompilare con il file binario giusto, a seconda della versione di PHP.  Si prega di fare riferimento al manuale PHP per ulteriori informazioni su come abilitare il supporto del database.',
