...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Database ondersteuning is niet gevonden. Controleer of u de benodigde stuurprogramma\'s hebt voor een van de volgende ondersteunde databasetypen: MySQL, MS SQLServer, Oracle of DB2.  Mogelijk moet u de extensie in php verwijderen.ini-bestand of hercompileren met het juiste binaire bestand, afhankelijk van uw versie van PHP.  Raadpleeg uw PHP-handleiding voor meer informatie over het inschakelen van Database-ondersteuning.',
