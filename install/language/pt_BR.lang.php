...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte ao banco de dados não foi encontrado. Confirme se você tem os drivers necessários para um dos seguintes tipos de banco de dados compatíveis: MySQL, MS SQLServer, Oracle ou DB2. Talvez seja necessário descomentar a extensão no arquivo php.ini ou recompilar com o arquivo binário correto, dependendo da sua versão do PHP. Consulte o manual do PHP para ver mais informações sobre como habilitar o suporte ao banco de dados.',
