...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasstöd kunde inte hittas.  Säkerställ att du har nödvändiga drivrutiner för en av följande databastyper som stöds: MySQL, MS SQLServer, Oracle eller DB2.  Du kan behöva ta bort tillägget i php.ini-fil, eller kompilera om med rätt binär fil, beroende på din version av PHP.  Se din PHP-manual för mer information om hur du aktiverar databasstöd.',
