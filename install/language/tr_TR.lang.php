...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veritabanı Desteği bulunamadı.  Lütfen aşağıdaki desteklenen Veri Tabanı Türlerinden biri için gerekli sürücülere sahip olduğunuzdan emin olun: MySQL, MS SQLServer, Oracle veya DB2.  Php.ini dosyasındaki uzantının yorumunu kaldırmanız veya PHP sürümünüze bağlı olarak doğru ikili dosyayla yeniden derlemeniz gerekebilir.  Veri Tabanı Desteğinin nasıl etkinleştirileceği hakkında daha fazla bilgi için lütfen PHP Kılavuzunuza bakın.',
