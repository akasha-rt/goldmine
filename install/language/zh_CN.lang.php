...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到数据库支持。请确保您具有以下受支持的数据库类型之一的必要驱动程序：MySQL、MS SQLServer、Oracle或DB2。您可能需要在php.ini文件中取消注释扩展，或使用正确的二进制文件重新编译，具体取决于您的PHP版本。有关如何启用数据库支持的更多信息，请参阅您的PHP手册。',
