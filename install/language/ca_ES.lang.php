...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat compatibilitat amb la base de dades. Assegureu-vos de tenir els controladors necessaris per a un dels següents tipus de bases de dades compatibles: MySQL, MS SQLServer, Oracle O DB2.  És possible que hagis de llevar els comentaris de l\'extensió en el fitxer php.ini, o recompilar amb el fitxer binari dret, depenent de lavostra versió de PHP. Consulteu el manual PHP per obtenir més informació sobre com habilitar la compatibilitat amb la base de dades.',
