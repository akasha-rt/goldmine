...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'תמיכה במסד נתונים לא נמצאה.  אנא ודא שיש לך מנהלי ההתקנים הדרושים עבור אחד הסוגים הבאים של מסדי נתונים נתמכים: MySQL, MS SQLServer, Oracle או DB2.  ייתכן שתצטרך להסיר הערה של הסיומת בקובץ php.ini או לבצע הידור מחדש עם הקובץ הבינארי הנכון, בהתאם לגרסת PHP שברשותך.  למידע נוסף על הפעלת התמיכה במסד הנתונים, נא לעיין במדריך ה-PHP.',
