...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Adatbázis-támogatás nem található. Kérjük, győződjön meg róla, hogy rendelkezik a szükséges illesztőprogramokkal a következő támogatott adatbázistípusokhoz: MySQL, MS SQLServer, Oracle vagy DB2. Elképzelhető, hogy el kell távolítania a kiterjesztést a php.ini fájlból, vagy újra össze kell állítania azt a megfelelő bináris fájllal, a PHP-verziójától függően. Kérjük, tekintse meg a PHP-kézikönyvet, ha több információra van szüksége az adatbázistámogatás engedélyezésével kapcsolatban.',
