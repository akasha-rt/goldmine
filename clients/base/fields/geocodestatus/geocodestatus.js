...
({
     ...
     */
    saveStatus: function() {
        const updateStatus = 'maps/updateGeocodeStatus';
        const requestType = 'create';

        const requestMeta = {
            id: this.model.get('id'),
            module: this.model.module,
            status: this._statuses[this._status] ? this._statuses[this._status] : this._failedStatus,
            fieldName: this.name,
        };

        const apiUrl = app.api.buildURL(updateStatus, requestType, requestMeta, {});

        app.api.call(requestType, apiUrl, requestMeta);
