...
({
    ...
    initialize: function(options) {
        ...
        this.active = ((this.model.get('active') || app.user.lastState.get(this.getActiveMetricKey())) ===
            this.meta.id);
    ...
    toggleActive: function() {
        if (!this.active) {
            app.user.lastState.set(this.getActiveMetricKey(), this.meta.id);
            this.model.set('active', this.meta.id);
