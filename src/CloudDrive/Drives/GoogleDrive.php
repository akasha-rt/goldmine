...
class GoogleDrive extends Drive
{
    ...
    public function listFiles(array $options)
    {
        ...
        $sortOptions = isset($options['sortOptions']) ? $options['sortOptions'] : false;
        $sharedWithMe = isset($options['sharedWithMe']) ? $options['sharedWithMe'] : false;
    ...
    public function downloadFile(array $options)
    {
        ...
        $usableMimeType = isset($this->usableMimeTypes[$mimeType]) ? $this->usableMimeTypes[$mimeType] : '';
