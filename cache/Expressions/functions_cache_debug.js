 ...
 */
SUGAR.FunctionMap = {
	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'strReplace'	:	SUGAR.expressions.StrReplaceExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'opportunitySalesStage'	:	SUGAR.expressions.OpportunitySalesStageExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'currentUserField'	:	SUGAR.expressions.CurrentUserFieldExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'forecastOnlySalesStages'	:	SUGAR.expressions.ForecastOnlySalesStageExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'dayofmonth'	:	SUGAR.expressions.DayOfMonthExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'now'	:	SUGAR.expressions.NowExpression,	'rollupConditionalMinDate'	:	SUGAR.expressions.MinDateConditionalRelatedExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'year'	:	SUGAR.expressions.YearExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'prorateValue'	:	SUGAR.expressions.ProrateValueExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'log'	:	SUGAR.expressions.LogExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'sentimentScoreToStr'	:	SUGAR.expressions.SentimentScoreToStringExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
