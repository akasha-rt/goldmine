<?php 
 $GLOBALS["dictionary"]["PU_PortalUsers"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pu_portalusers_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pu_portalusers_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pu_portalusers_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'pu_portalusers_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'pu_portalusers_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'module' => 'Accounts',
      'bean_name' => 'Account',
      'vname' => 'LBL_PU_PORTALUSERS_ACCOUNTS_1_FROM_ACCOUNTS_TITLE',
      'id_name' => 'pu_portalusers_accounts_1accounts_idb',
    ),
    'status_c' => 
    array (
      'labelValue' => 'Status',
      ...
      'options' => 'Type',
      'default' => NULL,
      'id' => '21ec628c-9353-11ed-9667-068c833ceba1',
      'custom_module' => 'PU_PortalUsers',
    ),
  ),
  'relationships' => 
  array (
    'pu_portalusers_modified_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    array (
      ...
      'relationship_role_column_value' => 'PU_PortalUsers',
    ),
    'pu_portalusers_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'pu_portalusers_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
    ...
    'pu_portalusers_email_addresses' => 
    array (
      'lhs_module' => 'PU_PortalUsers',
      'lhs_table' => 'pu_portalusers',
      'lhs_key' => 'id',
    ...
    'pu_portalusers_email_addresses_primary' => 
    array (
      'lhs_module' => 'PU_PortalUsers',
      'lhs_table' => 'pu_portalusers',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pu_portalusers_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pu_portalusers_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pu_portalusers_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pu_portalusers_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    0 => 
    array (
      'name' => 'idx_pu_portalusers_last_first',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'last_name',
    ...
    1 => 
    array (
      'name' => 'idx_pu_portalusers_first_last',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'first_name',
    ...
    'team_set_pu_portalusers' => 
    array (
      'name' => 'idx_pu_portalusers_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_pu_portalusers' => 
    array (
      'name' => 'idx_pu_portalusers_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pu_portalusers_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
