<?php 
 $GLOBALS["dictionary"]["sf_Dialogs"]=array (
  'table' => 'sf_dialogs',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_dialogs_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_dialogs_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'sf_dialogs_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'sf_dialogs_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'sf_dialogs_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'sf_dialogs_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_dialogs_assigned_user',
  ...
  array (
    ...
    'sf_dialogs_activities' => 
    array (
      'lhs_module' => 'sf_Dialogs',
      'lhs_table' => 'sf_dialogs',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'sf_Dialogs',
    ),
    'sf_dialogs_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_sf_dialogs_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
