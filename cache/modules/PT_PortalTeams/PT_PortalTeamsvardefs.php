<?php 
 $GLOBALS["dictionary"]["PT_PortalTeams"]=array (
  'table' => 'pt_portalteams',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pt_portalteams_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pt_portalteams_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pt_portalteams_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'pt_portalteams_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'pt_portalteams_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'module' => 'Accounts',
      'bean_name' => 'Account',
      'vname' => 'LBL_PT_PORTALTEAMS_ACCOUNTS_1_FROM_ACCOUNTS_TITLE',
      'id_name' => 'pt_portalteams_accounts_1accounts_idb',
    ),
    'producttemplates_pt_portalteams_1' => 
    array (
      'name' => 'producttemplates_pt_portalteams_1',
      'type' => 'link',
      'relationship' => 'producttemplates_pt_portalteams_1',
      'source' => 'non-db',
      'module' => 'ProductTemplates',
      'bean_name' => 'ProductTemplate',
      'vname' => 'LBL_PRODUCTTEMPLATES_PT_PORTALTEAMS_1_FROM_PRODUCTTEMPLATES_TITLE',
      'id_name' => 'producttemplates_pt_portalteams_1producttemplates_ida',
    ),
  ),
  'relationships' => 
  array (
    ...
    'pt_portalteams_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
    ...
    'pt_portalteams_email_addresses' => 
    array (
      'lhs_module' => 'PT_PortalTeams',
      'lhs_table' => 'pt_portalteams',
      'lhs_key' => 'id',
    ...
    'pt_portalteams_email_addresses_primary' => 
    array (
      'lhs_module' => 'PT_PortalTeams',
      'lhs_table' => 'pt_portalteams',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pt_portalteams_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pt_portalteams_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pt_portalteams_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pt_portalteams_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    0 => 
    array (
      'name' => 'idx_pt_portalteams_last_first',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'last_name',
    ...
    1 => 
    array (
      'name' => 'idx_pt_portalteams_first_last',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'first_name',
    ...
    'team_set_pt_portalteams' => 
    array (
      'name' => 'idx_pt_portalteams_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_pt_portalteams' => 
    array (
      'name' => 'idx_pt_portalteams_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pt_portalteams_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
