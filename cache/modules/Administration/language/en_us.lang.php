...
',
  ...
  'WARN_LICENSE_SEATS3_IDM' => '. <p class="error">Please deactivate some users in <a target="_blank" href=\'%s\'>SugarCloud Settings</a> or <a target="_blank" href=\'https://support.sugarcrm.com/Resources/Contacting_SugarCRM/\'>contact us</a> to add more licenses.</p>',
...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_SALESMANFINDER_EXPORT' => 'Export Salesman Finder',
  'LBL_SALESMANFINDER_EXPORT_DESCRIPTION' => 'Export Salesman Finder Database, and Download as CSV',
  'LBL_SALESMANFINDER_TRUNCATE' => 'Delete Salesman Finder Data',
  'LBL_SALESMANFINDER_TRUNCATE_DESCRIPTION' => 'Export, then Delete Salesman Finder Database',
  'LBL_SALESMANFINDER_GROUP' => 'Salesman Finder Export, Database Deletion Tools',
  'LBL_SALESMANFINDER_GROUP_DESCRIPTION' => 'Export Salesman Finder Database and Download as CSV.  Optionally Delete Contents of database to import new updates.',
  'LBL_E38_DEDUPIT_SECTION_HEADER' => 'DeDupit Configuration',
  'LBL_E38_DEDUPIT_SECTION_DESCRIPTION' => ' ',
  'LBL_VALIDATE_LICENSE_E38_DEDUPIT_LINK_NAME' => 'DeDupit License Configuration',
  'LBL_VALIDATE_LICENSE_E38_DEDUPIT_LINK_DESCRIPTION' => 'Validate license for DeDupit module',
  'LBL_E38_DEDUPIT_SUPPORT' => 'DeDupit Support',
  'LBL_E38_DEDUPIT_SUPPORT_DESCRIPTION' => 'Contact Sugar DeDupit Support',
  'LBL_WUSERUTILS_SETTINGS' => 'User Preference Management and Cloning',
  'LBL_WUSERUTILS_TITLE' => 'wUserUtils',
  'LBL_WUSERUTILS_DESCRIPTION' => 'Miscellaneous User Utility Tools',
  'LBL_WUSERUTILS_CONFIGURE_SETTINGS_DESCRIPTION' => 'Save time by cloning and managing user preferences, dashboards, filters. Control \'Login As\' access and System Maintenance Mode.',
  'LBL_WUSERUTILS_BRODCAST_TITLE' => 'Broadcast Message',
  'LBL_WUSERUTILS_BRODCAST_DESCRIPTION' => 'Configure a globally visible message header.',
  'LBL_WUSERUTILS_RESTRICT_LOGIN_TITLE' => 'Restrict Login Hours',
  'LBL_WUSERUTILS_RESTRICT_LOGIN_DESCRIPTION' => 'Specify the hours when users can log in.',
);