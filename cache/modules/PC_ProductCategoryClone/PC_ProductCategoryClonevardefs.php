<?php 
 $GLOBALS["dictionary"]["PC_ProductCategoryClone"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_assigned_user',
  ...
  array (
    ...
    'pc_productcategoryclone_commentlog' => 
    array (
      'lhs_module' => 'PC_ProductCategoryClone',
      'lhs_table' => 'pc_productcategoryclone',
      'lhs_key' => 'id',
    ...
    'pc_productcategoryclone_locked_fields' => 
    array (
      'lhs_module' => 'PC_ProductCategoryClone',
      'lhs_table' => 'pc_productcategoryclone',
      'lhs_key' => 'id',
    ...
    'pc_productcategoryclone_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_pc_productcategoryclone_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pc_productcategoryclone_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pc_productcategoryclone_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pc_productcategoryclone_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pc_productcategoryclone_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_pc_productcategoryclone_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'team_set_pc_productcategoryclone' => 
    array (
      'name' => 'idx_pc_productcategoryclone_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_pc_productcategoryclone' => 
    array (
      'name' => 'idx_pc_productcategoryclone_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pc_productcategoryclone_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
