...
3. Click "Save" to finalize the new record and return to the previous page.',
  'LBL_MEET_TYPE' => 'Meeting Type',
  'LBL_MEET_RESULT' => 'Meeting Result',
  'LBL_EDITVIEW_PANEL1' => 'New Panel 1',
  'LBL_MEET_PRODUCT' => 'Product Legacy',
  'LBL_PC_PRODUCTCATEGORYCLONE_MEETINGS_1_FROM_PC_PRODUCTCATEGORYCLONE_TITLE' => 'Product Category',
  'LBL_PC_PRODUCTCATEGORYCLONE_MEETINGS_1_FROM_MEETINGS_TITLE' => 'Product Category Clone',
  'LBL_GM_ACCOUNTNO' => 'GM Accountno',
  'LBL_GMRECID' => 'GM RecID',
  'LBL_PRODUCT_CATALOG_PRODUCTTEMPLATE_ID' => 'Product Catalog (related Product ID)',
  'LBL_PRODUCT_CATALOG' => 'Product',
  'LBL_REVENUE_LINE_ITEMS_REVENUELINEITEM_ID' => 'Revenue Line Items (related Revenue Line Item ID)',
  'LBL_REVENUE_LINE_ITEMS' => 'Revenue Line Items',
  'LBL_PC_PRODUCTCATEGORYCLONE_MEETINGS_1_NAME_PC_PRODUCTCATEGORYCLONE_ID' => 'Product Category (related Product Category Clone ID)',
  'LBL_PC_PRODUCTCATEGORYCLONE_MEETINGS_1_NAME_FIELD_TITLE' => 'Product Category',
  'LBL_IN_INCENTIVES_MEETINGS_1_FROM_IN_INCENTIVES_TITLE' => 'Incentives',
  'LBL_IN_INCENTIVES_MEETINGS_1_FROM_MEETINGS_TITLE' => 'Incentives',
  'LBL_MEETINGS_CC_COUPON_CODES_1_FROM_CC_COUPON_CODES_TITLE' => 'Coupon Codes',
  'LBL_MEETINGS_CC_COUPON_CODES_1_FROM_MEETINGS_TITLE' => 'Coupon Codes',
);