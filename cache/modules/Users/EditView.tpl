...
<span class="sugar_field" id="{$fields.address_street.name|escape:'html'|url2html|nl2br}">{$fields.address_street.value|escape:'html'|url2html|nl2br}</span>
...
<span class="sugar_field" id="{$fields.description.name|escape:'html'|url2html|nl2br}">{$fields.description.value|escape:'html'|url2html|nl2br}</span>
...
<tr>
    			...
    			{if $fields.user_hash.acl > 1 || ($showDetailData && $fields.user_hash.acl > 0)}
			   ...
			   {$label|strip_semicolon}:
                                                            ...
                                                            {if $fields.user_hash.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.user_hash.acl > 1 && $fields.user_hash.locked == false && $fields.user_hash.disabled == false}
		
							{counter name="panelFieldCount"}
			    
				
<input type='password' id='{$fields.user_hash.name}' 
name='{$fields.user_hash.name}' 
size='30' value='{$fields.user_hash.value}' title='' tabindex='0'	 >
...
<span class="sugar_field" id="{$fields.user_hash.name}">{$fields.user_hash.value}</span>
	...
	{/if}
    			...
    			{if $fields.pwd_last_changed.acl > 1 || ($showDetailData && $fields.pwd_last_changed.acl > 0)}
	
				<td valign="top" id='pwd_last_changed_label' width='12.5%' scope="col">
						   {capture name="label" assign="label"}{sugar_translate label='LBL_PSW_MODIFIED' module='Users'}{/capture}
			   {$label|strip_semicolon}:
										
                                                            {if $fields.pwd_last_changed.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.pwd_last_changed.acl > 1 && $fields.pwd_last_changed.locked == false && $fields.pwd_last_changed.disabled == false}
...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.pwd_last_changed.name}_trigger"{/capture}
...
{if strlen($fields.pwd_last_changed.value) <= 0}
    {assign var="value" value=$fields.pwd_last_changed.default_value }
{else}
    {assign var="value" value=$fields.pwd_last_changed.value }
{/if}



<span class="sugar_field" id="{$fields.pwd_last_changed.name}">{$value}</span>
...
<tr>
    			...
    			{if $fields.created_by_name.acl > 1 || ($showDetailData && $fields.created_by_name.acl > 0)}
	
				<td valign="top" id='created_by_name_label' width='12.5%' scope="col">
						   {capture name="label" assign="label"}{sugar_translate label='LBL_CREATED_BY_NAME' module='Users'}{/capture}
			   {$label|strip_semicolon}:
										
                                                            {if $fields.created_by_name.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.created_by_name.acl > 1 && $fields.created_by_name.locked == false && $fields.created_by_name.disabled == false}
		
							{counter name="panelFieldCount"}
			    
				
<input type="text" name="{$fields.created_by_name.name|escape:'html'}" class="sqsEnabled" tabindex="0" id="{$fields.created_by_name.name|escape:'html'}" size="" value="{$fields.created_by_name.value|escape:'html'}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.created_by_name.id_name|escape:'html'}" 
	id="{$fields.created_by_name.id_name|escape:'html'}" 
	value="{$fields.created_by.value|escape:'html'}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.created_by_name.name|escape:'html'}" id="btn_{$fields.created_by_name.name|escape:'html'}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_LABEL"}"
onclick='open_popup(
    "{$fields.created_by_name.module|escape:'html'}", 
	600, 
	400, 
	"", 
	true, 
	false, 
	{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"created_by","full_name":"created_by_name"}}{/literal}, 
	"single", 
	true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.created_by_name.name|escape:'html'}" id="btn_clr_{$fields.created_by_name.name|escape:'html'}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.created_by_name.name|escape:'html'}', '{$fields.created_by_name.id_name|escape:'html'}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.created_by_name.name|escape:'html'}']) != 'undefined'",
		enableQS
);
</script>
...
<span id="created_by" class="sugar_field" data-id-value="{$fields.created_by.value|escape:'html'}">{$fields.created_by_name.value|escape:'html'}</span>
	...
	{/if}
    			...
    			{if $fields.is_admin.acl > 1 || ($showDetailData && $fields.is_admin.acl > 0)}
	
				<td valign="top" id='is_admin_label' width='12.5%' scope="col">
						   {capture name="label" assign="label"}{sugar_translate label='LBL_IS_ADMIN' module='Users'}{/capture}
			   {$label|strip_semicolon}:
										
                                                            {if $fields.is_admin.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.is_admin.acl > 1 && $fields.is_admin.locked == false && $fields.is_admin.disabled == false}
...
{assign var="checked" value=""}
{/if}
<input type="checkbox" class="checkbox" name="{$fields.is_admin.name}" id="{$fields.is_admin.name}" value="$fields.is_admin.value" disabled="true" {$checked}>
...
<tr>
    			...
    			{if $fields.authenticate_id.acl > 1 || ($showDetailData && $fields.authenticate_id.acl > 0)}
	
				<td valign="top" id='authenticate_id_label' width='12.5%' scope="col">
						   {capture name="label" assign="label"}{sugar_translate label='LBL_AUTHENTICATE_ID' module='Users'}{/capture}
			   {$label|strip_semicolon}:
										
                                                            {if $fields.authenticate_id.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.authenticate_id.acl > 1 && $fields.authenticate_id.locked == false && $fields.authenticate_id.disabled == false}
		
							{counter name="panelFieldCount"}
			    
				
{if strlen($fields.authenticate_id.value) <= 0}
{assign var="value" value=$fields.authenticate_id.default_value }
{else}
{assign var="value" value=$fields.authenticate_id.value }
{/if}  
<input type='text' name='{$fields.authenticate_id.name}' 
    id='{$fields.authenticate_id.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''      >
									{else}
...
{assign var="value" value=$fields.authenticate_id.value }
{/if} 
<span class="sugar_field" id="{$fields.authenticate_id.name}">{$fields.authenticate_id.value}</span>
	...
	{/if}
    			...
    			{if $fields.sugar_login.acl > 1 || ($showDetailData && $fields.sugar_login.acl > 0)}
	
				<td valign="top" id='sugar_login_label' width='12.5%' scope="col">
						   {capture name="label" assign="label"}{sugar_translate label='LBL_SUGAR_LOGIN' module='Users'}{/capture}
			   {$label|strip_semicolon}:
										
                                                            {if $fields.sugar_login.locked == true}
                {$lockedIcon}
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if $fields.sugar_login.acl > 1 && $fields.sugar_login.locked == false && $fields.sugar_login.disabled == false}
		
							{counter name="panelFieldCount"}
			    
				
{if strval($fields.sugar_login.value) == "1" || strval($fields.sugar_login.value) == "yes" || strval($fields.sugar_login.value) == "on"} 
{assign var="checked" value="CHECKED"}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.sugar_login.name}" value="0"> 
<input type="checkbox" id="{$fields.sugar_login.name}" 
name="{$fields.sugar_login.name}" 
value="1" title='' tabindex="0" {$checked} >
...
{assign var="checked" value=""}
{/if}
<input type="checkbox" class="checkbox" name="{$fields.sugar_login.name}" id="{$fields.sugar_login.name}" value="$fields.sugar_login.value" disabled="true" {$checked}>
...
addToValidate('EditView', 'roundness_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ROUNDNESS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'bandsaw_c', 'bool', false,'{/literal}{sugar_translate label='LBL_BANDSAW' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dial_indicators_c', 'bool', false,'{/literal}{sugar_translate label='LBL_DIAL_INDICATORS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'granite_c', 'bool', false,'{/literal}{sugar_translate label='LBL_GRANITE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'vision_c', 'bool', false,'{/literal}{sugar_translate label='LBL_VISION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'gage_blocks_c', 'bool', false,'{/literal}{sugar_translate label='LBL_GAGE_BLOCKS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'mechanical_tools_c', 'bool', false,'{/literal}{sugar_translate label='LBL_MECHANICAL_TOOLS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'optical_c', 'bool', false,'{/literal}{sugar_translate label='LBL_OPTICAL' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'hardness_testers_c', 'bool', false,'{/literal}{sugar_translate label='LBL_HARDNESS_TESTERS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'surface_finish_c', 'bool', false,'{/literal}{sugar_translate label='LBL_SURFACE_FINISH' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'tapes_levels_c', 'bool', false,'{/literal}{sugar_translate label='LBL_TAPES_LEVELS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'electronic_tools_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ELECTRONIC_TOOLS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'force_measurement_c', 'bool', false,'{/literal}{sugar_translate label='LBL_FORCE_MEASUREMENT' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'hm_default_homepage_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_DEFAULT_HOMEPAGE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'hm_lockhomepage_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_LOCK_HOMEPAGE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'hm_only_once_c', 'bool', true,'{/literal}{sugar_translate label='LBL_HOMEPAGE_MANAGER_ONLY_ONCE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'hm_toggle_c', 'bool', true,'{/literal}{sugar_translate label='LBL_HOMEPAGE_TOGGLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'previously_licensed_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PREVIOUSLY_LICENSED' module='Users' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'created_by_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CREATED_BY_NAME' module='Users' for_js=true}{literal}', 'created_by' );
