...
>
			...
			<td>&nbsp;</td><td>&nbsp;</td>
			{/if}
							    	    			{if $fields.license_type.acl > 0}
					{counter name="fieldsUsed"}
						<td width='12.5%' scope="col">
								    {if !$fields.license_type.hidden}
			...
			<td width='37.5%'  >
			    			    {if !$fields.license_type.hidden}
									...
									{counter name="panelFieldCount"}
					<span id="license_type" class="sugar_field">{$LICENSE_TYPE_READONLY}</span>
...
{/if}
	...
	{capture name="tr" assign="tableRow"}
	<tr>
							    	    			{if $fields.business_center_name.acl > 0}
					{counter name="fieldsUsed"}
						<td width='12.5%' scope="col">
								    {if !$fields.business_center_name.hidden}
