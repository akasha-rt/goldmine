<?php 
 $GLOBALS["dictionary"]["IN_Incentives"]=array (
  'table' => 'in_incentives',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'in_incentives_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'in_incentives_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'in_incentives_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'in_incentives_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'in_incentives_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'in_incentives_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'in_incentives_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'in_incentives_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'in_incentives_assigned_user',
    ...
    'in_incentives_producttemplates_name' => 
    array (
    ...
    'pc_productcategoryclone_in_incentives_1_name' => 
    array (
      'name' => 'pc_productcategoryclone_in_incentives_1_name',
      'type' => 'relate',
      'source' => 'non-db',
      'vname' => 'LBL_PC_PRODUCTCATEGORYCLONE_IN_INCENTIVES_1_NAME_FIELD_TITLE',
      'save' => true,
      'id_name' => 'pc_productcd98ryclone_ida',
  ...
  array (
    ...
    'in_incentives_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_in_incentives_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_in_incentives_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_in_incentives_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_in_incentives' => 
    array (
      'name' => 'idx_in_incentives_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_in_incentives' => 
    array (
      'name' => 'idx_in_incentives_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_in_incentives_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
