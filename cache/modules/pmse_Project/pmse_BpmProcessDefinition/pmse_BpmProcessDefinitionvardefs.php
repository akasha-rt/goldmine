<?php 
 $GLOBALS["dictionary"]["pmse_BpmProcessDefinition"]=array (
  ...
  array (
    ...
    'externalusers_locked_fields_link' => 
    array (
      'name' => 'externalusers_locked_fields_link',
      'vname' => 'ExternalUsers',
      'type' => 'link',
      'relationship' => 'externalusers_locked_fields',
      'source' => 'non-db',
    ),
    ...
    'sf1_salesmanfinder_locked_fields_link' => 
    array (
      'name' => 'sf1_salesmanfinder_locked_fields_link',
      'vname' => 'SF1_SalesmanFinder',
      'type' => 'link',
      'relationship' => 'sf1_salesmanfinder_locked_fields',
      'source' => 'non-db',
    ),
    'fl_foreignleadsrouting_locked_fields_link' => 
    array (
      'name' => 'fl_foreignleadsrouting_locked_fields_link',
      'vname' => 'FL_ForeignLeadsRouting',
      'type' => 'link',
      'relationship' => 'fl_foreignleadsrouting_locked_fields',
      'source' => 'non-db',
    ),
    'som_specialorderquotes_locked_fields_link' => 
    array (
      'name' => 'som_specialorderquotes_locked_fields_link',
      'vname' => 'SOM_SpecialOrderQuotes',
      'type' => 'link',
      'relationship' => 'som_specialorderquotes_locked_fields',
      'source' => 'non-db',
    ),
    'cc_coupon_codes_locked_fields_link' => 
    array (
      'name' => 'cc_coupon_codes_locked_fields_link',
      'vname' => 'CC_Coupon_Codes',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_locked_fields',
      'source' => 'non-db',
    ),
    'in_incentives_locked_fields_link' => 
    array (
      'name' => 'in_incentives_locked_fields_link',
      'vname' => 'IN_Incentives',
      'type' => 'link',
      'relationship' => 'in_incentives_locked_fields',
      'source' => 'non-db',
    ),
    'pc_productcategoryclone_locked_fields_link' => 
    array (
      'name' => 'pc_productcategoryclone_locked_fields_link',
      'vname' => 'PC_ProductCategoryClone',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_locked_fields',
      'source' => 'non-db',
    ),
    'e38_duplicatefinderprocess_locked_fields_link' => 
    array (
      'name' => 'e38_duplicatefinderprocess_locked_fields_link',
      'vname' => 'E38_DuplicateFinderProcess',
      'type' => 'link',
      'relationship' => 'e38_duplicatefinderprocess_locked_fields',
      'source' => 'non-db',
    ),
    'e38_foundduplicates_locked_fields_link' => 
    array (
      'name' => 'e38_foundduplicates_locked_fields_link',
      'vname' => 'E38_FoundDuplicates',
      'type' => 'link',
      'relationship' => 'e38_foundduplicates_locked_fields',
      'source' => 'non-db',
    ),
    'sf_webactivity_locked_fields_link' => 
    array (
      'name' => 'sf_webactivity_locked_fields_link',
      'vname' => 'sf_webActivity',
      'type' => 'link',
      'relationship' => 'sf_webactivity_locked_fields',
      'source' => 'non-db',
    ),
    'lss01_groupemails_locked_fields_link' => 
    array (
      'name' => 'lss01_groupemails_locked_fields_link',
      'vname' => 'LSS01_GroupEmails',
      'type' => 'link',
      'relationship' => 'lss01_groupemails_locked_fields',
      'source' => 'non-db',
    ),
    'pu_portalusers_locked_fields_link' => 
    array (
      'name' => 'pu_portalusers_locked_fields_link',
      'vname' => 'PU_PortalUsers',
      'type' => 'link',
      'relationship' => 'pu_portalusers_locked_fields',
      'source' => 'non-db',
    ),
    'pt_portalteams_locked_fields_link' => 
    array (
      'name' => 'pt_portalteams_locked_fields_link',
      'vname' => 'PT_PortalTeams',
      'type' => 'link',
      'relationship' => 'pt_portalteams_locked_fields',
      'source' => 'non-db',
    ),
    'pa_productaccessories_locked_fields_link' => 
    array (
      'name' => 'pa_productaccessories_locked_fields_link',
      'vname' => 'PA_ProductAccessories',
      'type' => 'link',
      'relationship' => 'pa_productaccessories_locked_fields',
      'source' => 'non-db',
    ),
    'following' => 
    array (
