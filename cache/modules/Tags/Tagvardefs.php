 ...
 $GLOBALS["dictionary"]["Tag"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'fl_foreignleadsrouting_tags',
      'source' => 'non-db',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'som_specialorderquotes_tags',
      'source' => 'non-db',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_tags',
      'source' => 'non-db',
    ),
    'in_incentives_link' => 
    array (
      ...
      'vname' => 'IN_Incentives',
      'type' => 'link',
      'relationship' => 'in_incentives_tags',
      'source' => 'non-db',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_tags',
      'source' => 'non-db',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'e38_mergedduplicates_tags',
      'source' => 'non-db',
    ),
    'sf_webactivity_link' => 
    array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_tags',
      'source' => 'non-db',
    ),
    'sf_dialogs_link' => 
    array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_tags',
      'source' => 'non-db',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'lss01_groupemails_tags',
      'source' => 'non-db',
    ),
    'pu_portalusers_link' => 
    array (
      ...
      'type' => 'link',
      'relationship' => 'pu_portalusers_tags',
      'source' => 'non-db',
    ),
    'pt_portalteams_link' => 
    array (
      ...
      'type' => 'link',
      'relationship' => 'pt_portalteams_tags',
      'source' => 'non-db',
    ),
