<?php 
 $GLOBALS["dictionary"]["sf_WebActivityDetail"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'sf_webactivitydetail_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_assigned_user',
  ...
  'relationships' => 
  array (
    'sf_webactivitydetail_modified_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sf_webactivitydetail_created_by' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sf_webactivitydetail_activities' => 
    array (
      'lhs_module' => 'sf_WebActivityDetail',
      'lhs_table' => 'sf_webactivitydetail',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'sf_WebActivityDetail',
    ),
    'sf_webactivitydetail_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sf_webactivitydetail_commentlog' => 
    array (
      'lhs_module' => 'sf_WebActivityDetail',
      'lhs_table' => 'sf_webactivitydetail',
      'lhs_key' => 'id',
    ...
    'sf_webactivitydetail_locked_fields' => 
    array (
      'lhs_module' => 'sf_WebActivityDetail',
      'lhs_table' => 'sf_webactivitydetail',
      'lhs_key' => 'id',
    ...
    'sf_webactivitydetail_assigned_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_sf_webactivitydetail_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_sf_webactivitydetail_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_sf_webactivitydetail_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_sf_webactivitydetail_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_sf_webactivitydetail_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_sf_webactivitydetail_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_sf_webactivitydetail_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
