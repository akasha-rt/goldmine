<?php 
 $GLOBALS["dictionary"]["CommentLog"]=array (
  ...
  array (
    ...
    'sf1_salesmanfinder_link' => 
    array (
      'name' => 'sf1_salesmanfinder_link',
      'vname' => 'SF1_SalesmanFinder',
      'type' => 'link',
      'relationship' => 'sf1_salesmanfinder_commentlog',
      'source' => 'non-db',
    ),
    'fl_foreignleadsrouting_link' => 
    array (
      'name' => 'fl_foreignleadsrouting_link',
      'vname' => 'FL_ForeignLeadsRouting',
      'type' => 'link',
      'relationship' => 'fl_foreignleadsrouting_commentlog',
      'source' => 'non-db',
    ),
    'som_specialorderquotes_link' => 
    array (
      'name' => 'som_specialorderquotes_link',
      'vname' => 'SOM_SpecialOrderQuotes',
      'type' => 'link',
      'relationship' => 'som_specialorderquotes_commentlog',
      'source' => 'non-db',
    ),
    'cc_coupon_codes_link' => 
    array (
      'name' => 'cc_coupon_codes_link',
      'vname' => 'CC_Coupon_Codes',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_commentlog',
      'source' => 'non-db',
    ),
    'in_incentives_link' => 
    array (
      'name' => 'in_incentives_link',
      'vname' => 'IN_Incentives',
      'type' => 'link',
      'relationship' => 'in_incentives_commentlog',
      'source' => 'non-db',
    ),
    'pc_productcategoryclone_link' => 
    array (
      'name' => 'pc_productcategoryclone_link',
      'vname' => 'PC_ProductCategoryClone',
      'type' => 'link',
      'relationship' => 'pc_productcategoryclone_commentlog',
      'source' => 'non-db',
    ),
    'e38_duplicatecheck_link' => 
    array (
      'name' => 'e38_duplicatecheck_link',
      'vname' => 'E38_DuplicateCheck',
      'type' => 'link',
      'relationship' => 'e38_duplicatecheck_commentlog',
      'source' => 'non-db',
    ),
    'e38_duplicatefinderprocess_link' => 
    array (
      'name' => 'e38_duplicatefinderprocess_link',
      'vname' => 'E38_DuplicateFinderProcess',
      'type' => 'link',
      'relationship' => 'e38_duplicatefinderprocess_commentlog',
      'source' => 'non-db',
    ),
    'e38_foundduplicates_link' => 
    array (
      'name' => 'e38_foundduplicates_link',
      'vname' => 'E38_FoundDuplicates',
      'type' => 'link',
      'relationship' => 'e38_foundduplicates_commentlog',
      'source' => 'non-db',
    ),
    'e38_mergedduplicates_link' => 
    array (
      'name' => 'e38_mergedduplicates_link',
      'vname' => 'E38_MergedDuplicates',
      'type' => 'link',
      'relationship' => 'e38_mergedduplicates_commentlog',
      'source' => 'non-db',
    ),
    'sf_webactivity_link' => 
    array (
      'name' => 'sf_webactivity_link',
      'vname' => 'sf_webActivity',
      'type' => 'link',
      'relationship' => 'sf_webactivity_commentlog',
      'source' => 'non-db',
    ),
    'sf_webactivitydetail_link' => 
    array (
      'name' => 'sf_webactivitydetail_link',
      'vname' => 'sf_WebActivityDetail',
      'type' => 'link',
      'relationship' => 'sf_webactivitydetail_commentlog',
      'source' => 'non-db',
    ),
    'sf_dialogs_link' => 
    array (
      'name' => 'sf_dialogs_link',
      'vname' => 'sf_Dialogs',
      'type' => 'link',
      'relationship' => 'sf_dialogs_commentlog',
      'source' => 'non-db',
    ),
    'sf_eventmanagement_link' => 
    array (
      'name' => 'sf_eventmanagement_link',
      'vname' => 'sf_EventManagement',
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_commentlog',
      'source' => 'non-db',
    ),
    'lss01_groupemails_link' => 
    array (
      'name' => 'lss01_groupemails_link',
      'vname' => 'LSS01_GroupEmails',
      'type' => 'link',
      'relationship' => 'lss01_groupemails_commentlog',
      'source' => 'non-db',
    ),
    'pu_portalusers_link' => 
    array (
      'name' => 'pu_portalusers_link',
      'vname' => 'PU_PortalUsers',
      'type' => 'link',
      'relationship' => 'pu_portalusers_commentlog',
      'source' => 'non-db',
    ),
    'pt_portalteams_link' => 
    array (
      'name' => 'pt_portalteams_link',
      'vname' => 'PT_PortalTeams',
      'type' => 'link',
      'relationship' => 'pt_portalteams_commentlog',
      'source' => 'non-db',
    ),
    'pa_productaccessories_link' => 
    array (
      'name' => 'pa_productaccessories_link',
      'vname' => 'PA_ProductAccessories',
      'type' => 'link',
      'relationship' => 'pa_productaccessories_commentlog',
      'source' => 'non-db',
    ),
    'following' => 
    array (
