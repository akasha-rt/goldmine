 ...
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      ...
      'help' => 'Format: Account Name or End User - Product Category (MIX) or Product ID',
      'comments' => '',
    ...
    'specialist_c' => 
    array (
      'labelValue' => 'Product Specialist',
      'dependency' => '',
      'required' => false,
      'readonly' => false,
      'source' => 'non-db',
      'name' => 'specialist_c',
      'vname' => 'LBL_SPECIALIST',
      'type' => 'relate',
      'massupdate' => false,
      'hidemassupdate' => false,
      'no_default' => false,
    ...
    array (
      ...
      'len' => 255,
      'size' => '20',
      'id' => 'Opportunitiestogglereminder_c',
      'custom_module' => 'Opportunities',
    ),
    'strat_prod_line_c' => 
    array (
      ...
      'id' => 'Opportunitiesstrat_prod_line_c',
      'custom_module' => 'Opportunities',
    ),
    'remindertime_c' => 
    array (
      'labelValue' => 'Remind In',
      'dependency' => 'equal($togglereminder_c,true)',
      'visibility_grid' => '',
      'full_text_search' => 
      array (
        'boost' => 1,
      ...
      'id' => 'Opportunitiesremindertime_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    'customercontact_c' => 
    array (
      'labelValue' => 'End User Contact',
      'dependency' => '',
      'required' => false,
      'readonly' => false,
      'source' => 'non-db',
      'name' => 'customercontact_c',
      'vname' => 'LBL_CUSTOMERCONTACT',
      'type' => 'relate',
      'massupdate' => false,
      'hidemassupdate' => false,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiescustomercontact_c',
      'custom_module' => 'Opportunities',
    ),
    'competitor_c' => 
    array (
      'labelValue' => 'Competitor(s)',
      'full_text_search' => 
      array (
        'enabled' => true,
        'boost' => '1',
      ...
      'enforced' => '',
      'dependency' => 'equal($opportunity_type,"Conversion")',
      'required' => false,
      'readonly' => false,
      'source' => 'custom_fields',
      'name' => 'competitor_c',
    ...
    array (
      ...
      'type' => 'relate',
      'source' => 'non-db',
      'vname' => 'LBL_PC_PRODUCTCATEGORYCLONE_OPPORTUNITIES_1_NAME_FIELD_TITLE',
      'save' => true,
      'id_name' => 'pc_product9b3eryclone_ida',
    ...
    'in_incentives_opportunities_1_name' => 
    array (
    ...
    array (
      ...
      'calculated' => 'true',
      'formula' => 'abs(subtract(daysUntil($date_entered),daysUntil(today())))',
      'enforced' => 'true',
      'dependency' => '',
      'required_formula' => '',
      'readonly_formula' => '',
      ...
      'min' => false,
      'max' => false,
      'id' => '7f2fb5d4-bfc4-11eb-9c51-06fc4560ea04',
      'custom_module' => 'Opportunities',
    ),
    'denorm_account_name' => 
    array (
    ...
    array (
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => '8e2121d4-5c64-11ed-9116-02f4f61106cc',
      'custom_module' => 'Opportunities',
    ),
    'prod_group_c' => 
    array (
    ...
    array (
      ...
      'showTransactionalAmount' => true,
      'precision' => 6,
      'id' => 'fa69d0c0-98dc-11ed-92c6-06bef78d6e58',
      'custom_module' => 'Opportunities',
    ),
    'probabilitypercentage_c' => 
    array (
      ...
      'readonly' => false,
      'source' => 'custom_fields',
      'name' => 'probabilitypercentage_c',
      'vname' => 'LBL_PROBABILITYPERCENTAGE',
      'type' => 'int',
      'massupdate' => true,
      'hidemassupdate' => false,
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'a8a67a44-98dd-11ed-8425-024df0977c5d',
      'custom_module' => 'Opportunities',
    ),
    ...
    'campaigns_opportunities_1_name' => 
    array (
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'contact_id1_c',
      'vname' => 'LBL_CUSTOMERCONTACT_CONTACT_ID',
      'type' => 'id',
      'massupdate' => false,
      'hidemassupdate' => false,
      'no_default' => false,
