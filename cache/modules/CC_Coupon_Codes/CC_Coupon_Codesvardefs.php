<?php 
 $GLOBALS["dictionary"]["CC_Coupon_Codes"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'cc_coupon_codes_assigned_user',
    ...
    'cc_coupon_codes_opportunities_name' => 
    array (
    ...
    'in_incentives_cc_coupon_codes_name' => 
    array (
    ...
    'meetings_cc_coupon_codes_1_name' => 
    array (
  ...
  array (
    ...
    'cc_coupon_codes_activities' => 
    array (
      'lhs_module' => 'CC_Coupon_Codes',
      'lhs_table' => 'cc_coupon_codes',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'CC_Coupon_Codes',
    ),
    'cc_coupon_codes_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'cc_coupon_codes_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_cc_coupon_codes_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_cc_coupon_codes_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_cc_coupon_codes_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_cc_coupon_codes_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_cc_coupon_codes' => 
    array (
      'name' => 'idx_cc_coupon_codes_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_cc_coupon_codes' => 
    array (
      'name' => 'idx_cc_coupon_codes_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_cc_coupon_codes_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
