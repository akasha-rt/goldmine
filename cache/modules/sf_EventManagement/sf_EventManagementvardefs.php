<?php 
 $GLOBALS["dictionary"]["sf_EventManagement"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'sf_eventmanagement_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sf_eventmanagement_assigned_user',
  ...
  'relationships' => 
  array (
    'sf_eventmanagement_modified_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sf_eventmanagement_activities' => 
    array (
      'lhs_module' => 'sf_EventManagement',
      'lhs_table' => 'sf_eventmanagement',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'sf_EventManagement',
    ),
    'sf_eventmanagement_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sf_eventmanagement_locked_fields' => 
    array (
      'lhs_module' => 'sf_EventManagement',
      'lhs_table' => 'sf_eventmanagement',
      'lhs_key' => 'id',
    ...
    'sf_eventmanagement_assigned_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_sf_eventmanagement_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_sf_eventmanagement_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_sf_eventmanagement_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_sf_eventmanagement_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_sf_eventmanagement_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_sf_eventmanagement_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_sf_eventmanagement_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
