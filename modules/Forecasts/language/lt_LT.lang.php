...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigūruokite, kaip norite kategorizuoti {{forecastByModule}}. <br><br>Atkreipkite dėmesį, kad diapazono nuostatos negali būti keičiamos po pirmojo įsipareigojimo. Atnaujintų atvejų diapazono nuostata užrakinama su esamais prognozės duomenimis.<br><br>Galite pasirinkti bent dvi kategorijas pagal tikimybių diapazonus arba kurti kategorijas, kurios nėra pagrįstos tikimybe. <br><br>Jūsų pasirinktinių kategorijų kairėje yra žymimieji langeliai; naudokite juos, kad nuspręstumėte, kurie diapazonai bus įtraukti į numatomą sumą, apie kurią pranešama vadovams. <br><br>Vartotojas gali rankiniu būdu pakeisti {{forecastByModule}} įtraukimo / neįtraukimo būseną ir kategoriją iš savo darbalapio.',
