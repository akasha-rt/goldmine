...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren.<br><br>Houd er rekening mee dat de Bereikinstellingen niet kunnen worden gewijzigd na de eerste bevestiging. Voor geüpgradede exemplaren is de bereikinstelling vergrendeld met bestaande Voorspellingsgegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheidsbereik of u kunt categorieën maken die niet op waarschijnlijkheid zijn gebaseerd.<br><br>Met de selectievakjes aan de linkerkant van uw aangepaste categorieën kunt u beslissen welke marges zullen worden opgenomen in het voorspelde bedrag dat is vastgelegd en gerapporteerd aan managers. <br><br>Een gebruiker kan de status Insluiten/Uitsluiten en categorie {{forecastByModule}} handmatig wijzigen vanuit het werkblad.',
