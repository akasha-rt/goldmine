...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดค่าวิธีที่คุณต้องการจัดหมวดหมู่ {{forecastByModule}} <br><br>โปรดทราบว่าการตั้งค่าช่วงไม่สามารถเปลี่ยนแปลงได้หลังจากยืนยันครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรดการตั้งค่าช่วงจะถูกล็อกด้วยข้อมูลการคาดการณ์ที่มีอยู่<br><br>คุณอาจเลือกสองประเภทหรือมากกว่าขึ้นอยู่กับช่วงความน่าจะเป็นหรือสร้างหมวดหมู่ที่ไม่ได้ขึ้นอยู่กับความน่าจะเป็น <br><br>มีช่องทำเครื่องหมายทางด้านซ้ายของหมวดหมู่ที่กำหนดเองของคุณใช้ช่องเหล่านี้เพื่อ <br><br>ผู้ใช้อาจเปลี่ยนแปลงสถานะรวม/ไม่รวมและหมวดหมู่ของ {{forecastByModule}} ด้วยตนเองจากแผ่นงานของ',
