...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר כיצד לסווג {{forecastByModule}}. <br><br>לידיעתך, אי אפשר לשנות הגדרות &#39;טווח&#39; אחרי הביצוע הראשון. במופעים משודרגים, ההגדרה &#39;טווח&#39; נעולה עם נתוני התחזית הקיימים.<br><br>באפשרותך לבחור שתי קטגוריות או יותר, לפי טווחי סבירות, או ליצור קטגוריות, שלא מבוססות על סבירות. <br><br>לצד הקטגוריות המותאמות יש תיבות סימון, שבאמצעותן אפשר לקבוע אילו טווחים לכלול בסכום התחזית, אשר מבוצע ונשלח למנהלים. <br><br>משתמש רשאי לשנות מצב כלילה/אי כלילה וקטגוריה של {{forecastByModule}}, ידנית מגיליון העבודה שלו.',
