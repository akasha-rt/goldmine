...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Állítsa be, hogyan szeretné kategorizálni a következőt: {{forecastByModule}}. <br><br>Kérjük, ne feledje, hogy a tartománybeállítások nem változtathatók meg az első megerősítést követően. Továbbfejlesztett munkamenetek esetén a tartománybeállítás zárolva van a meglévő előrejelzési adatokkal.<br><br>Kiválaszthat kettő vagy több kategóriát a valószínűségtartományok alapján, vagy létrehozhat olyan kategóriákat, amelyek nem a valószínűségen alapulnak.<br><br>Az egyedi kategóriák bal oldalán jelölőnégyzetek találhatók; használja ezeket annak kijelölésére, hogy mely tartományokat szeretné belefoglalni a megerősített előrejelzési mennyiségbe, és kerülnek jelentésre a vezetőjének. <br><br>Egy felhasználó megváltoztathatja a befoglalás/kihagyás állapotot és a(z) {{forecastByModule}} állapotát manuálisan a munkalapjáról.',
