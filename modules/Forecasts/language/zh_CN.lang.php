...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '配置您希望对 {{forecastByModule}} 进行分类的方式。 <br><br>请注意，第一次提交后不能更改范围设置。对于升级的实例，范围设置与现有预测数据一起锁定。<br><br>您可以根据概率范围选择两个或多个类别或创建不基于概率的类别。 <br><br>您的自定义类别的左侧有复选框；使用这些来决定哪些范围将包含在提交并报告给经理的预测金额中。 <br><br>用户可以从其工作表手动更改 {{forecastByModule}} 的包含/排除状态和类别。',
