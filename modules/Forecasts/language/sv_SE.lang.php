...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Observera att Intervallinställningarna inte kan ändras efter det första åtagandet. För uppgraderade instanser är Intervallinställningen låst med befintliga prognosdata.<br><br>Du kan välja två eller flera kategorier baserat på sannolikhetsintervall eller skapa kategorier som inte är baserade på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier - använd dessa för att bestämma vilka intervall som ska ingå i det prognosbelopp som åtas och rapporteras till chefer. <br><br>En användare kan ändra inkludera/exkludera-status och kategori för {{forecastByModule}} manuellt från sitt kalkylblad.',
