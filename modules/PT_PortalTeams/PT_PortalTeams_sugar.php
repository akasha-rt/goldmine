 ...
 * PLACE ANY CUSTOMIZATIONS IN PT_PortalTeams
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class PT_PortalTeams_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'PT_PortalTeams';
    public $object_name = 'PT_PortalTeams';
    public $table_name = 'pt_portalteams';
