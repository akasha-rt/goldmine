...
({
    ...
    _registerEvents: function() {
        ...
        if (_.has(this, 'layout') && this.layout && _.has(this.layout, 'layout') && this.layout.layout) {
            this.listenTo(this.layout.layout, 'panel:collapse', this._collapseFilters, this);
            this.listenTo(this.layout.layout, 'panel:minimize', this.panelMinimizedCollapsed, this);
        }
    },
     ...
     */
    panelMinimizedCollapsed: function(minimized) {
        this._setTitle('LBL_REPORTS_FILTERS', minimized);
    },
    ...
    _failedLoadReportData: function(error) {
        ...
        this.layout.trigger('panel:widget:finished:loading', this._canMinimize(), false);
        this.context.trigger('report:data:filters:loaded', false);
    ...
    /**
     * Can minimize filters panel
     *
     * @return {boolean}
     */
    _canMinimize: function() {
        let minimize = true;

        if (_.has(this, 'layout') &&
            this.layout &&
            _.has(this.layout, 'layout') &&
            this.layout.layout &&
            typeof this.layout.layout.isMinimized === 'function') {
            minimize = !this.layout.layout.isMinimized();
        }
    ...
    /**
     * Collapse/Maximize the filters widget
     *
     * @param {boolean} collapse
     */
    _collapseFilters: function(collapse) {
        if (collapse) {
            this.$el.hide();
        } else {
            this.$el.show();
        ...
        this.panelMinimizedCollapsed(collapse);
    },
    ...
    _showHiddenFilters: function(show) {
        ...
        if (show) {
            ...
            this._setTitle('LBL_REPORTS_FILTERS', !this._canMinimize());
    ...
    _showEmptyFilters: function(show, noAccess) {
        ...
        this.context.trigger('report:data:filters:loaded', !show);
