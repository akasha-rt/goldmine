...
({
    ...
    _storeReportData: function(data) {
        ...
        this.context.trigger('report:data:chart:loaded', false);
        this._setFooter();
    ...
    _showEmptyChart: function(show, noAccess) {
        ...
        this.context.trigger('report:data:chart:loaded', !show);
    ...
    _getYaxisLabel: function(data) {
        ...
        if (data && data.summary_columns) {
            _.each(data.summary_columns, function getLabel(column) {
