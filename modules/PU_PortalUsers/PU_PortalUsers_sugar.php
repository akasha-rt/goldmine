 ...
 * PLACE ANY CUSTOMIZATIONS IN PU_PortalUsers
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class PU_PortalUsers_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'PU_PortalUsers';
    public $object_name = 'PU_PortalUsers';
    public $table_name = 'pu_portalusers';
