...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'<b>Paigutuse</b> ala sisaldab välju, mida kuvatakse praegu <b>kiirgeneraatori</b> vormil.<br><br>Kiirgeneraatori vorm on leitav mooduli alampaneelidelt, kui klõpsate nupul „Loo“.<br/><br/> <b>Tööriistakast</b> sisaldab <b>prügikasti</b> funktsiooni ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Paigutuse muutmiseks pukseerige elemente ja välju <b>tööriistakasti</b> ja <b>paigutuse</b> funktsioonide vahel ning paigutuse siseselt.<br><br>Välja eemaldamiseks paigutusest lohistage väli <b>prügikasti</b>. Väli on seejärel tööriistakastis paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tähistab sõltuvat välja, mis valemi väärtusest sõltuvalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tähistab arvutatud välja, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        //this defualt will be used for edit view
        'default'	=> '<b>Paigutuse</b> ala sisaldab välju, mida kuvatakse praegu <b>redigeerimisvaates</b>.<br/><br/> <b>Tööriistakast</b> sisaldab <b>prügikasti</b> funktsiooni ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Paigutuse muutmiseks pukseerige elemente ja välju <b>tööriistakasti</b> ja <b>paigutuse</b> funktsioonide vahel ning paigutuse siseselt.<br><br>Välja eemaldamiseks paigutusest lohistage väli <b>prügikasti</b>. Väli on seejärel tööriistakastis paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tähistab sõltuvat välja, mis valemi väärtusest sõltuvalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tähistab arvutatud välja, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_FIELD_DELETE'=>'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\n\nKas soovite jätkata?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas olete kindel, et soovite selle suhte kustutada?<br>Märkus: selle toimingu lõpule viimiseks võib kuluda mitu minutit.',
...
,
'LBL_POPHELP_CALCULATED'=>"Selle välja väärtuse määramiseks looge valem.<br>"
   . "Tegevust hõlmavad töövoo definitsioonid, mis on seadistatud seda välja värskendama, ei teosta enam seda tegevust.<br>"
...
'LBL_POPHELP_DEPENDENT'=>"Looge valem, et määrata, kas see väli on paigutustes nähtav.<br/>"
        ...
        . "aga ei järgi valemit omarakendustes, nagu Sugar Mobile iPhone'i jaoks.<br/>"
        . "Valemit ei järgita Sugari iseteenindusportaalis.",
'LBL_POPHELP_REQUIRED'=>"Looge valem, et määrata, kas see väli on paigutustes nõutav.<br/>"
    . "Nõutavad väljad järgivad brauseripõhises mobiilivaates valemit, <br/>"
    . "aga ei järgi valemit omarakendustes, nagu Sugar Mobile iPhone'i jaoks.<br/>"
    . "Valemit ei järgita Sugari iseteenindusportaalis.",
'LBL_POPHELP_READONLY'=>"Looge valem, et määrata, kas see väli on paigutustes kirjutuskaitstud.<br/>"
        . "Kirjutuskaitstud väljad järgivad brauseripõhises mobiilivaates valemit, <br/>"
        . "aga ei järgi valemit omarakendustes, nagu Sugar Mobile iPhone'i jaoks.<br/>"
        . "Valemit ei järgita Sugari iseteenindusportaalis.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige selle välja kasutamine, kui otsite selles moodulis kirjeid globaalse otsingu abil.',
