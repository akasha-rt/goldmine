...
'LBL_POPHELP_READONLY'=>"Krijo një formulë për të përcaktuar nëse kjo fushë është vetëm për lexim në formatime.<br/>"
        . "Fushat vetëm për lexim do të ndjekin formulën në pamjen celulare të bazuar në shfletues,<br/>"
        . "por nuk do të ndjekin formulën në aplikacionet origjinale, si \"Sugar Mobile\" për \"iPhone\". <br/>"
        . "Ato nuk do të ndjekin formulën në portalin e vetëshërbimit të \"Sugar\".",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Zgjidhe këtë opsion për ta përdorur këtë fushë në kërkimin e regjistrimeve duke përdorur kërkimin global në këtë modul.',
