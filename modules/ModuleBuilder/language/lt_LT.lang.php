...
'LBL_CONFIRM_FIELD_DELETE'=>'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete.'
        ...
        . '\n\nAr norite tęsti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Ar tikrai norite ištrinti šiuos santykius?<br>Pastaba: ši operacija gali užtrukti kelias minutes.',
...
,
'LBL_POPHELP_CALCULATED'=>"Sukurkite formulę šio lauko vertei nustatyti.<br>"
   . "Darbo eigos apibrėžtys, kuriose yra veiksmas, nustatytos atnaujinti šį lauką, veiksmo nebevykdys.<br>"
   . "Laukai, kuriuose naudojamos formulės, nebus apskaičiuojami realiuoju laiku "
...
'LBL_POPHELP_DEPENDENT'=>"Sukurkite formulę, kad nustatytumėte, ar šis laukas matomas maketuose.<br/>"
        . "Priklausomi laukai atitiks priklausomybės formulę naršyklės pagrindu veikiančiame mobiliajame rodinyje, <br/>"
        . "bet neatitiks formulės vietinėse programose, pavyzdžiui, „Sugar Mobile“, skirtoje „iPhone“. <br/>"
        . "Jie neatitiks formulės „Sugar“ savitarnos portale.",
'LBL_POPHELP_REQUIRED'=>"Sukurkite formulę, kad nustatytumėte, ar šis laukas būtinas maketuose.<br/>"
    . "Būtini laukai atitiks formulę naršyklės pagrindu veikiančiame mobiliajame rodinyje, <br/>"
    . "bet neatitiks formulės vietinėse programose, pavyzdžiui, „Sugar Mobile“, skirtoje „iPhone“. <br/>"
    . "Jie neatitiks formulės „Sugar“ savitarnos portale.",
'LBL_POPHELP_READONLY'=>"Sukurkite formulę, kad nustatytumėte, ar šis laukas tik skaitomas maketuose.<br/>"
        . "Tik skaitomi laukai atitiks formulę naršyklės pagrindu veikiančiame mobiliajame rodinyje, <br/>"
        . "bet neatitiks formulės vietinėse programose, pavyzdžiui, „Sugar Mobile“, skirtoje „iPhone“. <br/>"
        . "Jie neatitiks formulės „Sugar“ savitarnos portale.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Pasirinkite naudoti šį lauką ieškodami įrašų naudodami visuotinę paiešką šiame modulyje.',
