...
'LBL_POPHELP_DEPENDENT'=>"Vytvorte vzorec na určenie, či je toto pole viditeľné v rozloženiach.<br/>"
        . "Závislé polia sa budú riadiť vzorcom závislostí v zobrazení v prehliadači v mobilných zariadeniach, <br/>"
...
'LBL_POPHELP_REQUIRED'=>"Vytvorte vzorec na určenie, či je toto pole v rozloženiach povinné.<br/>"
    . "Povinné polia sa budú riadiť vzorcom v zobrazení v prehliadači v mobilných zariadeniach, <br/>"
    . "ale nebudú sa riadiť vzorcom v natívnych aplikáciách, ako je Sugar Mobile pre iPhone. <br/>"
    . "Nebudú sa riadiť vzorcom na samoobslužnom portáli Sugar.",
'LBL_POPHELP_READONLY'=>"Vytvorte vzorec na určenie, či je toto pole určené iba na čítanie v rozloženiach.<br/>"
        . "Polia iba na čítanie sa budú riadiť vzorcom v zobrazení v prehliadači v mobilných zariadeniach, <br/>"
        . "ale nebudú sa riadiť vzorcom v natívnych aplikáciách, ako je Sugar Mobile pre iPhone. <br/>"
        . "Nebudú sa riadiť vzorcom na samoobslužnom portáli Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Vyberte, ak chcete toto pole použiť pri vyhľadávaní záznamov pomocou globálneho vyhľadávania v tomto module.',
