...
'LBL_POPHELP_READONLY'=>"Crea una fórmula per determinar si aquest camp es mostra només a les disposicions.<br/>"
        . "Els camps llegits seguiran la fórmula a la vista mòbil basada en navegador, <br/>"
        . "but will not follow the formula in the native applications, such as Sugar Mobile for iPhone. <br/>"
        . "No seguiran la fórmula al Portal autoservei de Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Seleccioneu per a usar aquest camp en cercar registres usant La Cerca Global en aquest mòdul.',
