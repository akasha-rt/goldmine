...
'LBL_POPHELP_READONLY'=>"Vytvořte vzorec a určete, zda je toto pole v rozvrženích pouze ke čtení.<br/>"
        . "Pole pouze ke čtení se budou řídit vzorcem v mobilním zobrazení s využitím prohlížeče, <br/>"
        . "nebudou se ale řídit vzorcem v nativních aplikacích, jako je Sugar Mobile pro iPhone. <br/>"
        . "Nebudou se řídit vzorcem v samoobslužném portálu Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Vyberte, zda chcete toto pole použít při hledání záznamů pomocí obecného vyhledávání v tomto modulu.',
