...
'LBL_POPHELP_READONLY'=>"Erstellen Sie eine Formel, um festzustellen, ob dieses Feld nur in Layouts gelesen wird.<br/>"
        . "Schreibgeschützte Felder folgen zwar der Formel in der browserbasierten mobilen Ansicht, <br/>"
        . "folgen jedoch nicht der Formel in nativen Anwendungen wie Sugar Mobile für iPhone. <br/>"
        . "Sie folgen nicht der Formel im Sugar-Selbstbedienungsportal.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Wählen Sie dieses Feld, um mithilfe der globalen Suche nach Datensätzen auf diesem Modul zu suchen.',
