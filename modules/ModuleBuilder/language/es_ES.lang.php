...
'LBL_POPHELP_READONLY'=>"Crear una fórmula para determinar si este campo se muestra solo en los diseños.<br/>"
        . "Los campos leídos seguirán la fórmula en la vista móvil basada en navegador, <br/>"
        . "pero no seguirán la fórmula en las aplicaciones nativas, como Sugar Mobile para iPhone. <br/>"
        . "No seguirán la fórmula en el Portal autoservicio de Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Seleccione esta opción para utilizar este campo al buscar registros mediante la búsqueda global de este módulo.',
