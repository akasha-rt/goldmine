...
'LBL_POPHELP_READONLY'=>"Skapa en formel för att avgöra om detta fält är skrivskyddat i layouter.<br/>"
        ...
        . "De kommer inte att följa formeln för Sugar Self-Service-portalen.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Välj om du vill använda det här fältet när du söker efter poster med hjälp av den globala sökningen på den här modulen.',
