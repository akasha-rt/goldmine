...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moodul {{plural_module_name}} võimaldab teil jälgida üksikuid müüke algusest lõpuni. Iga mooduli {{module_name}} kirje tähistab tulevast müüki ja sisaldab asjakohaseid müügiandmeid, samuti muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne. Moodul {{module_name}} teeb tavaliselt läbi mitu müügietappi, enne kui sellele lisatakse kas märge „Lõpetatud – võidetud“ või „Lõpetatud – kaotatud“. Moodulit {{plural_module_name}} on võimalik veelgi enam võimendada, kasutades Sugari moodulit {{forecasts_singular_module}} müügitrendide mõistmiseks ning prognoosimiseks, aga ka müügikvootide täitmisele keskendumiseks.',
...
- Selle kirje väljade muutmiseks klõpsake üksikut välja või muutmise nuppu.
...
- Lisategevusi saab valida tegevuste rippmenüüst, mis asub muutmise nupust paremal.',
