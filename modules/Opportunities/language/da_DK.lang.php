...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulet {{plural_module_name}} giver dig mulighed for at spore individuelle salg fra start til slut. Hver {{module_name}}-post repræsenterer et potentielt salg og indeholder relevante salgsdata samt relaterer til andre vigtige poster som {{quotes_module}}, {{contacts_module}} osv. En {{module_name}} vil typisk gennemgå flere salgsfaser, indtil den markeres som "afsluttet vundet" eller "afsluttet mistet". {{plural_module_name}} kan udnyttes endnu mere ved at bruge Sugars {{forecasts_singular_module}} modul til at forstå og forudsige salgstendenser samt fokusere arbejdet for at opnå salgskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulet {{plural_module_name}} giver dig mulighed for at spore individuelle salg og de linjeelementer, der hører til disse salg, fra start til slut. Hver {{module_name}}-post repræsenterer et potentielt salg og opfatter relevante salgsdata samt oplysninger om andre vigtige poster som {{quotes_module}}, {{contacts_module}} osv.

- Redigér felter for denne post ved at klikke på et individuelt felt eller på knappen Redigér.
- Se eller rediger links til andre poster i underpanelerne ved at skifte nederste venstre rude til "Datavisning".
- Skriv og se brugerkommentarer og historik over ændringer af registreringer i {{activitystream_singular_module}} ved at skifte nederste venstre rude til "Activity Stream".
