...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '您可以通過 {{plural_module_name}} 模塊從頭到尾跟踪單個銷售。每條 {{module_name}} 記錄代表一次潛在銷售，包括相關銷售數據以及與 {{quotes_module}}、{{contacts_module}} 等其他重要記錄相關的數據。 {{module_name}} 通常會經歷幾個銷售階段，直到標記為“談成已結束”或“丟單已結束”。通過使用 Sugar 的 {{forecasts_singular_module}} 模塊，可以進一步利用 {{plural_module_name}} 來了解和預測銷售趨勢以及專注於實現銷售配額的工作。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模塊允許您全程追踪個人銷售和這些銷售的明細項目。每條 {{module_name}} 記錄代表一次潛在銷售，包括相關銷售數據以及與 {{quotes_module}}、{{contacts_module}} 等其他重要記錄相關的數據。
...
- “編輯”按鈕右側的下拉“操作”菜單提供其他操作選項。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模塊允許您全程追踪個人銷售和這些銷售的明細項目。每條 {{module_name}} 記錄代表一次潛在銷售，包括相關銷售數據以及與 {{quotes_module}}、{{contacts_module}} 等其他重要記錄相關的數據。
