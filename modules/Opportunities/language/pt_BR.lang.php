...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O módulo {{plural_module_name}} permite acompanhar vendas individuais do início ao fim. Cada registo do {{module_name}} representa uma venda potencial e inclui dados de venda relevantes, além de relacionados com outros registos importantes como {{quotes_module}}, {{contacts_module}} etc. Um {{module_name}} normalmente progredirá por vários Estágios de venda até ser marcado como "Fechado ganho" ou "Fechado perdido". {{plural_module_name}} podem ser aproveitados ainda mais usando o módulo de {{forecasts_singular_module}} do Sugar para compreender e prever as tendências de vendas, além de focar o trabalho para alcançar as quotas de vendas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'O módulo {{plural_module_name}} permite acompanhar vendas individuais e os itens de linha que pertencem a essas vendas do início ao fim. Cada registro do módulo {{module_name}} representa uma venda potencial e inclui dados de vendas relevantes, além de estar relacionado a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc.
