...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'De module {{plural_module_name}} biedt u de mogelijkheid om de individuele verkoop van begin tot eind te volgen. Elke {{module_name}} record vertegenwoordigt een mogelijke verkoop en bevat relevante verkoopgegevens, evenals gegevens m.b.t. andere belangrijke records zoals {{quotes_module}}, {{contacts_module}}, etc. Een {{module_name}} doorloopt doorgaans meerdere verkoopfases tot deze wordt gemakeerd als "Gesloten, gewonnen" of "Gesloten, verloren". {{plural_module_name}} kan verder worden ingezet door de module {{forecasts_singular_module}} van Sugar te begrijpen en verkooptrends te voorspellen, en om werk zo in te richten om verkoopquota&#39;s te behalen.',
