...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} присвячений потенційному продажу й містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. Модуль {{module_name}} зазвичай проходить кілька стадій продажу, доки не отримає статус «Закритий успішний продаж» або «Закритий невдалий продаж». Користь від застосування модуля {{plural_module_name}} можна збільшити, використовуючи модуль {{forecasts_singular_module}} системи Sugar для аналізу та прогнозування тенденцій продажів, а також для зосередження роботи на досягненні встановлених квот збуту.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що належать до них, від початку до кінця. Кожен модуль {{module_name}} присвячений потенційному продажу й містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.
...
- Щоб залишати та переглядати коментарі користувачів, а також змінювати історію в межах запису в {{activitystream_singular_module}}, перемкніть ліву нижню панель у режим «Стрічка активності». 
- Щоб стежити за цим записом або додати його до вибраного, використовуйте піктограми праворуч від назви запису. 
- Додаткові дії доступні в розкривному меню «Дії» праворуч від кнопки «Редагувати».',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що до них належать, від початку до кінця. Кожен запис {{module_name}} присвячений потенційному предмету продажу й містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. 

Щоб створити модуль {{module_name}}, виконайте зазначені нижче дії. 
1. Укажіть потрібні значення полів.
 - Перед збереженням необхідно заповнити поля з позначкою «Обов’язково».
