...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '您可以通过 {{plural_module_name}} 模块从头到尾跟踪单个销售。每条 {{module_name}} 记录代表一次潜在销售，包括相关销售数据以及与 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关的数据。{{module_name}} 通常会经历几个销售阶段，直到标记为“谈成已结束”或“丢单已结束”。通过使用 Sugar 的 {{forecasts_singular_module}} 模块，可以进一步利用 {{plural_module_name}} 来了解和预测销售趋势以及专注于实现销售配额的工作。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模块允许您全程追踪个人销售和这些销售的明细项目。每条 {{module_name}} 记录代表一次潜在销售，包括相关销售数据以及与 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关的数据。
...
- “编辑”按钮右侧的下拉“操作”菜单提供其他操作选项。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模块允许您全程追踪个人销售和这些销售的明细项目。每条 {{module_name}} 记录代表一次潜在销售，包括相关销售数据以及与 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关的数据。
