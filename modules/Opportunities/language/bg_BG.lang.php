...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} ви позволява да следите отделните продажби от началото до края. Всеки запис на {{module_name}} представя перспективна продажби и включва съответни данни за продажбата както и как се свързва с други важни записи като {{quotes_module}}, {{contacts_module}}, etc. Един модул {{module_name}} обикновено ще премине през няколко етапа на продажба, докато не бъде отбелязана или като „Затворена спечелена", или като „Затворена загубена". {{plural_module_name}} може да бъде използван по-нататък с помощта модула {{forecasts_singular_module}} на Sugar за разбиране и предсказване на тенденции на продажби, както и фокусирана работа за постигане на офертите за продажби.',
