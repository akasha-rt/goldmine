...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Das Modul {{plural_module_name}} ermöglicht es Ihnen, einzelne Verkäufe von Anfang bis Ende zu verfolgen. Jeder {{module_name}}-Datensatz steht für einen potenziellen Verkauf und enthält relevante Verkaufsdaten sowie Angaben zu anderen wichtigen Datensätzen wie {{quotes_module}}, {{contacts_module}}, usw. Ein {{module_name}} durchläuft in der Regel mehrere Verkaufsstufen, bis er entweder als "Gewonnener Abschluss" oder "Verlorener Abschluss" markiert wird. {{plural_module_name}} kann sogar noch weiter genutzt werden durch die Verwendung des Sugar-Moduls {{forecasts_singular_module}}, um Verkaufstrends zu verstehen und vorherzusagen sowie die Arbeit auf das Erreichen von Verkaufsquoten zu konzentrieren.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe und die dazugehörigen Einzelposten von Anfang bis Ende verfolgen. Jeder {{module_name}}-Datensatz steht für einen potenziellen Verkauf und enthält relevante Verkaufsdaten sowie Angaben zu anderen wichtigen Datensätzen wie {{quotes_module}}, {{contacts_module}}, usw.

- Bearbeiten Sie Felder dieses Datensatzes, indem Sie auf ein einzelnes Feld oder auf die Schaltfläche Bearbeiten klicken.
- Zeigen Sie Verknüpfungen zu anderen Datensätzen in den Unterfenstern an oder ändern Sie diese, indem Sie den unteren linken Bereich auf "Datenansicht" umschalten.
- Erstellen und betrachten Sie Benutzerkommentare und zeichnen Sie den Änderungsverlauf im {{activitystream_singular_module}} auf, indem Sie den unteren linken Bereich auf "Activity Stream" umschalten.
- Folgen Sie diesem Eintrag oder markieren Sie ihn als Favorit mit den Symbolen rechts neben dem Eintragsnamen.
- Weitere Aktionen sind im Dropdown-Menü "Aktionen" rechts neben der Schaltfläche "Bearbeiten" verfügbar.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe und die dazugehörigen Einzelposten von Anfang bis Ende verfolgen. Jeder {{module_name}}-Datensatz steht für einen potenziellen Verkauf und enthält relevante Verkaufsdaten sowie Angaben zu anderen wichtigen Datensätzen wie {{quotes_module}}, {{contacts_module}}, usw.

Um einen {{module_name}} zu erstellen:
1. Geben Sie die gewünschten Werte für die Felder ein.
 ...
 - Klicken Sie auf "Mehr anzeigen", um weitere Felder anzuzeigen, falls erforderlich.
