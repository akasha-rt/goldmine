...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'تسمح الوحدة {{plural_module_name}} لك بتتبع المبيعات الفردية من البداية إلى النهاية. يمثل كل سجل {{module_name}} عملية بيع متوقعة ويتضمن بيانات المبيعات ذات الصلة، ويرتبط كذلك بالسجلات المهمة الأخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ. ستتقدم {{module_name}} بصورة نموذجية عبر مراحل المبيعات المتعددة حتى وضع علامة "إغلاق لسبب الفوز" أو "إغلاق لسبب الخسارة". يمكن الاستفادة من {{plural_module_name}} بصورة أكبر باستخدام وحدة {{forecasts_singular_module}} في Sugar لفهم اتجاهات المبيعات والتنبؤ بها وكذلك تركيز العمل لتحقيق الحصص النسبية من المبيعات.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'تسمح لك الوحدة {{plural_module_name}} بتتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية إلى النهاية. يمثل كل سجل {{module_name}} عملية بيع متوقعة ويتضمن بيانات المبيعات ذات الصلة، ويرتبط كذلك بالسجلات المهمة الأخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ.
...
- تتوفر إجراءات إضافية في القائمة "الإجراءات" المنسدلة إلى يمين الزر "تحرير".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'تسمح لك الوحدة {{plural_module_name}} بتتبع المبيعات الفردية والبنود التي تنتمي لهذه المبيعات من البداية إلى النهاية. يمثل كل سجل من سجلات {{module_name}} عملية بيع متوقعة ويتضمن بيانات المبيعات ذات الصلة، ويرتبط كذلك بالسجلات المهمة الأخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ.

لإنشاء {{module_name}}:
1. قم بتزويد القيم في الحقول حسب الرغبة.
