...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg fra start til slutt. Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevante salgsdata samt relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}} osv. En {{module_name}} vil vanligvis gå gjennom flere salgsstadier til det er merket enten «Avsluttet vunnet» eller «Avsluttet tapt». {{plural_module_name}} kan utnyttes enda mer ved å bruke Sugars {{forecasts_singular_module}}modul for å forstå og forutsi salgstrender samt fokusere arbeid for å oppnå salgskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjeelementene som tilhører disse salgene fra start til slutt. Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevante salgsdata i tillegg til andre viktige poster som {{quotes_module}}, {{contacts_module}} osv.

- Rediger denne postens felter ved å klikke på et enkelt felt eller Rediger-knappen.
- Se eller endre lenker til andre poster i underpanelene ved å bytte ruten nederst til venstre til "Datavisning".
- Lag og se brukerkommentarer og registrer endringshistorikk i {{activitystream_singular_module}} ved å bytte ruten nederst til venstre til «Aktivitetsstrøm».
- Følg eller angi denne posten som favoritt ved å bruke ikonene til høyre for postens navn.
- Ytterligere handlinger kan velges fra rullegardinmenyen Handlinger til høyre for Rediger-knappen.',
...
1. Oppgi verdier for feltene etter ønske.
  - Felter merket med VObligatorisk» må fylles ut før lagring.
