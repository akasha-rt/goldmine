...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale, de la început până la sfârșit. Fiecare înregistrare din {{module_name}} reprezintă o vânzare potențială și include date relevante despre vânzare și alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc. Un modul {{module_name}} va trece în mod obișnuit prin câteva Etape de vânzări până când este marcat fie „Câștig închis”, fie „Pierdere închisă”. {{plural_module_name}} poate fi valorificat și mai mult folosind modulul {{forecasts_singular_module}} de la Sugar pentru a înțelege și pentru a prevedea tendințe de vânzări și pentru a viza atingerea cotelor de vânzări.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzări individuale și elemente de linie ce aparțin acestor vânzări, de la început până la sfârșit. Fiecare înregistrare din {{module_name}} reprezintă o vânzare potențială și include date relevante despre vânzare și alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.

- Editați câmpurile acestei înregistrări făcând clic pe un câmp individual sau pe butonul Editare.
- Vizualizați sau modificați linkurile la alte înregistrări din subpanouri comutând panoul din stânga jos la „Vizualizare date”.
- Interacționați cu comentariile utilizatorilor şi vizualizați istoricul de modificări ale înregistrării {{activitystream_singular_module}} comutând panoul din stânga jos la „Flux de activități”.
- Urmăriți sau marcați ca favorită această înregistrare folosind pictogramele din dreapta denumirii înregistrării.
- Acțiuni suplimentare sunt disponibile în meniul vertical Acțiuni, la dreapta butonului Editare.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzări individuale și elemente de linie ce aparțin acestor vânzări, de la început până la sfârșit. Fiecare înregistrare din {{module_name}} reprezintă o vânzare potențială și include date relevante despre vânzare și alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
...
1. Introduceți valori pentru câmpuri după cum doriți.
 ...
 - Faceți clic pe „Afişare mai multe” pentru a afişa câmpuri suplimentare.
2. Faceți clic pe „Salvare” pentru a finaliza noua înregistrare şi pentru a reveni la pagina anterioară.',
