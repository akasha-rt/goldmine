...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduli {{plural_module_name}} të lejon të gjurmosh shitjet individuale nga fillimi në fund. Secili regjistrim në {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhëna me rëndësi mbi shitjen, si dhe regjistrime të tjera përkatëse të rëndësishme, të tilla si {{quotes_module}}, {{contacts_module}} etj. Një {{module_name}} do të kalojë zakonisht në disa faza shitjesh, derisa të shënohet si "Fitim i mbyllur" ose "Humbje e mbyllur". {{plural_module_name}} mund të shfrytëzohet edhe më tej duke përdorur modulin {{forecasts_singular_module}} të Sugar për të kuptuar dhe për të parashikuar tendencat e shitjeve, si dhe për të fokusuar punën në arritjen e kuotave të shitjeve.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduli {{plural_module_name}} të lejon të gjurmosh shitjet individuale dhe artikujt e linjës që i përkasin atyre shitjeve, nga fillimi në fund. Secili regjistrim në {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhëna me rëndësi mbi shitjen, si dhe regjistrime të tjera përkatëse të rëndësishme, të tilla si {{quotes_module}}, {{contacts_module}} etj.

- Modifiko fushat e këtij regjistrimi duke klikuar një fushë individuale ose butonin "Modifiko".
- Shiko ose modifiko lidhjet në regjistrimet e tjera në nënpanele duke kaluar nga paneli majtas poshtë te "Pamja e të dhënave".
- Ndërvepro me komentet e përdoruesit dhe shiko historikun e ndryshimit të regjistrimit në {{activitystream_singular_module}} duke kaluar nga paneli majtas poshtë te "Transmetimi i aktivitetit".
- Veprimet shtesë janë të disponueshme në menynë me lëshim poshtë "Veprimet", në të djathtë të butonit "Modifiko".',
...
1. Jep vlerat për fushat sipas dëshirës.
 - Fushat e shënuara me "Të nevojshme" duhet të plotësohen para se të ruhen.
 - Kliko "Trego më shumë" për të paraqitur fusha shtesë nëse është e nevojshme.
