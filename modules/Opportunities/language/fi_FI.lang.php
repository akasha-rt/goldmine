...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduulin {{plural_module_name}} avulla voit seurata yksittäisiä myyntejä alusta loppuun. Jokainen {{module_name}}-tietue edustaa mahdollista myyntiä ja sisältää asiaankuuluvat myyntitiedot sekä sen, liittyykö se muihin tärkeisiin tietueisiin, kuten {{quotes_module}}, {{contacts_module}} jne. {{module_name}} etenee yleensä useiden myyntivaiheiden läpi, kunnes se on merkitty joko "Suljettu voitettu" tai "Suljettu hävitty". {{plural_module_name}}-moduulia voidaan hyödyntää entisestään käyttämällä Sugarin {{forecasts_singular_module}}ing-moduulia myyntitrendien ymmärtämiseen ja ennustamiseen sekä työskentelyn keskittämiseen myyntikiintiöiden saavuttamiseen.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduulin {{plural_module_name}} avulla voit seurata yksittäisiä myyntejä ja niihin liittyviä rivikohteita alusta loppuun. Jokainen {{module_name}}-tietue edustaa mahdollista myyntiä ja sisältää myyntitietoja sekä muita tärkeitä tietueita, kuten {{quotes_module}}, {{contacts_module}} jne.

- Muokkaa tämän tietueen kenttiä napsauttamalla yksittäistä kenttää tai Muokkaa-painiketta.
- Tarkastele tai muokkaa linkkejä muihin tietueisiin alapaneelissa vaihtamalla vasemman alakulman ruutu "Tietonäkymä"-tilaan.
- Kirjoita ja tarkastele käyttäjien kommentteja ja tallenna muutoshistoria {{activitystream_singular_module}}-moduuliin vaihtamalla vasemman alakulman paneeli kohtaan "Aktiviteettivirta".
- Seuraa tätä tietuetta tai lisää se suosikkeihin käyttämällä tietueen nimen oikealla puolella olevia kuvakkeita.
- Lisätoiminnot ovat saatavilla Muokkaa-painikkeen oikealla puolella olevasta avattavasta Toimintovalikosta.',
