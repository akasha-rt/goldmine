...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Il modulo {{plural_module_name}} ti consente di monitorare le singole vendite dall&#39;inizio alla fine. Ogni record {{module_name}} rappresenta una vendita potenziale e include dati di vendita rilevanti, nonché relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}}, ecc. Un {{module_name}} in genere progredisce attraverso diverse fasi di vendita fino a quando non viene contrassegnato come "vinto chiuso" o "perso chiuso". {{plural_module_name}} può essere ulteriormente sfruttato utilizzando il modulo {{forecasts_singular_module}} di Sugar per comprendere e prevedere le tendenze di vendita e concentrare il lavoro per raggiungere le quote di vendita.',
...
- Crea e visualizza i commenti degli utenti e registra la cronologia delle modifiche nel {{activitystream_singular_module}} spostando il riquadro in basso a sinistra su "Streaming attività".
...
1. Fornire i valori per i campi come desiderato.
 ...
 - Fai clic su "Mostra altro" per visualizzare campi aggiuntivi, se necessario.
