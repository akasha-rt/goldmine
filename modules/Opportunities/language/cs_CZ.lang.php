...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} umožňuje sledovat jednotlivé prodeje od začátku do konce. Každý záznam {{module_name}} představuje potenciální prodej a obsahuje příslušné prodejní údaje a také se vztahuje k dalším důležitým záznamům, jako je {{quotes_module}}, {{contacts_module}} atd. Modul {{module_name}} obvykle postupuje přes několik prodejních fází, dokud není označen buď jako „Uzavřeno úspěšně“ nebo „Uzavřeno neúspěšně“. Modul {{plural_module_name}} lze využít ještě dále pomocí modulu {{forecasts_singular_module}} Sugar, abyste mohli porozumět prodejním trendům a předpovídat je, jakož i zaměřit své úsilí na dosažení prodejních kvót.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} umožňuje sledovat jednotlivé prodeje a řádkové položky, které k těmto prodejům patří, od začátku do konce. Každý záznam {{module_name}} představuje potenciální prodej a obsahuje příslušné prodejní údaje a také se vztahuje k dalším důležitým záznamům, jako je {{quotes_module}}, {{contacts_module}} atd.

- Upravte pole záznamu kliknutím na jednotlivá pole nebo na tlačítko Upravit.
- Zobrazte nebo upravte vazby na ostatní záznamy v subpanelech tím, že přepnete spodní levý panel na „Zobrazení dat“.
...
- Další akce jsou dostupné v rozevírací nabídce Akce vpravo od tlačítka Upravit.',
