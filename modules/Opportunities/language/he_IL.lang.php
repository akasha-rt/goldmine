...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות מתחילתן ועד לסיומן. כל רשומת {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתוני מכירה רלוונטיים וכן נתונים בנוגע לרשומות חשובות נוספות כמו {{quotes_module}}‏, {{contacts_module}} וכו&#39;. מודול {{module_name}} יתקדם בדרך כלל על פי מספר שלבי מכירה עד שיסומן כ"נסגר בהצלחה" או "נסגר ואבד". ניתן למנף את {{plural_module_name}} אפילו יותר באמצעות מודול {{forecasts_singular_module}} של Sugar כדי להבין ולחזות מגמות מכירה ולמקד את העבודה בהשגת מכסות מכירה.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות ואחר פריטי השורה המשויכים למכירות אלה מתחילתן ועד לסיומן. כל רשומת {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתונים רלוונטיים למכירה וכן נתונים בנוגע לרשומות חשובות נוספות כמו {{quotes_module}}‏, {{contacts_module}} וכו&#39;.

- ניתן לערוך את שדות הרשומה בלחיצה על כל שדה בנפרד או על לחצן "ערוך".
- ניתן להציג או לשנות קישורים לרשומות אחרות בלוחות המשנה על ידי החלפת מצב החלונית השמאלית התחתונה ל"תצוגת נתונים".
- ניתן לכתוב או להציג הערות משתמשים והיסטוריית שינויים ברשומות שבמודול {{activitystream_singular_module}} על ידי החלפת מצב החלונית השמאלית התחתונה ל"זרם פעילות".
- ניתן לעקוב אחר רשומה זו או להוסיף אותה לרשימת המועדפים באמצעות הסמלים שמימין לשמה.
...
1. יש להזין ערכים בשדות כנדרש.
 - יש להזין נתונים בשדות החובה לפני השמירה.
 - ניתן ללחוץ על "הצג עוד" כדי להציג שדות נוספים, במידת הצורך.
2. יש ללחוץ על "שמור" כדי לסיים את גיבוש הרשומה החדשה ולחזור לדף הקודם.',
