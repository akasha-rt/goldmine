...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}modulen låter dig hålla koll på individuella försäljningar från början till slut. Varje {{module_name}} uppgift representerar en framtida försäljning och inkluderar relevant försäljningsdata samtidigt som det relaterar till andra viktiga uppgifter så som {{quotes_module}},{{contacts_module}}, m.m. {{module_name}} kommer vanligvis gå igenom flera försäljningslägen innan den markeras som "Stängd vann" eller "Stängd förlorad". {{plural_module_name}} kan också användas vidare genom att använda Sugars {{forecasts_singular_module}}modul för att förstå och förutse försäljningstrender samt fokusera jobbet för att nå försäljningskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulen {{plural_module_name}} gör det möjligt för dig att spåra individuella försäljningar från början till slut. Varje {{module_name}}-post representerar en framtida försäljning och innehåller relevant försäljningsinformation samt är kopplad till andra viktiga poster som {{quotes_module}}, {{contacts_module}} osv.
...
- Gör och visa användarkommentarer och registrera ändringshistorik i {{activitystream_singular_module}} genom att växla nedre vänstra rutan till "Aktivitetsflöde".
...
- Ytterligare åtgärder är tillgängliga i rullgardinsmenyn Åtgärder till höger om knappen Redigera.',
    ...
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} gör det möjligt dig att spåra individuella försäljningar och poster från de försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning, innehåller relevant försäljningsinformation och är kopplad till andra viktiga poster som {{quotes_module}}, {{contacts_module}} osv.
...
1. Ange värden för fälten efter önskemål.
 ...
 - Klicka på "Visa mer" för att visa ytterligare fält vid behov.
