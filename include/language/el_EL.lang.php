...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        ...
        'donut chart' => 'Γράφημα ντόνατ',
        'treemap chart' => 'Γράφημα Treemap',
        'bar chart' => 'Διάγραμμα κατακόρυφης μπάρας',
        'group by chart' => 'Ομαδοποιημένο γράφημα κάθετης μπάρας',
        'horizontal bar chart' => 'Γράφημα Οριζόντιας Μπάρας',
        'horizontal group by chart' => 'Ομαδοποιημένο Γράφημα Οριζόντιας Μπάρας',
        'line chart' => 'Γράφημα Γραμμής',
        'funnel chart' => 'Γράφημα τύπου χωνιού',
    ),
...
Αν εκτελέσετε αυτήν την ενέργεια, θα αποσυνδεθείτε αμέσως και θα χρειαστεί να κάνετε ξανά έλεγχο ταυτότητας χρησιμοποιώντας την εφαρμογή ελέγχου ταυτότητας την επόμενη φορά που θα συνδεθείτε.',
  ...
  'ERR_FILE_NOT_FOUND' => 'Λάθος: Δεν μπόρεσε να φορτώσει το αρχείο {0}. Παρακαλώ ελέγξτε το σύστημα και τα δικαιώματα διαδικτύου του διακομιστή.',
    ...
    'LBL_ACTION_UPDATE_FAILURE' => "Αποτυχία αποθήκευσης της εγγραφής => \n {{{reason}}}",
    ...
    'LBL_ERROR_IMAGE_LOAD_FAILED' => "Σφάλμα' => Απέτυχε η φόρτωση του αρχείου ως εικόνας",
    ...
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Πρέπει να επιλεγεί τουλάχιστον μία τιμή.',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => 'Μόνο ο κάτοχος της Αναφοράς μπορεί να επεξεργαστεί φίλτρα.',
...
// Omnichannel
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'Δείτε την πιο πρόσφατη δραστηριότητα περίπτωσης που έχετε δημιουργήσει ή έχετε μοιραστεί.',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = 'Embedded File';
    ...
    $app_strings['LBL_SHARED_WITH_ME'] = 'Που μου αποστάληκε';
