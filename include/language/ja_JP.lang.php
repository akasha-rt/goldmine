...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        'pie chart' => '円グラフ',
        'donut chart' => 'ドーナツグラフ',
        'treemap chart' => 'ツリーマップグラフ',
        'bar chart' => '縦棒グラフ',
        'group by chart' => '集合縦棒グラフ',
        'horizontal bar chart' => '横棒グラフ',
        'horizontal group by chart' => '集合横棒グラフ',
        'line chart' => '折れ線グラフ',
...
"5. アプリケーションでアクションメニューのインポートオプションをクリックしてアップロードするファイルを選択します"   ',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => 'フィルターを編集できるのは、レポートの所有者のみです。',
...
// Omnichannel
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'あなたが作成した、または共有している最新のケースアクティビティを表示します。',
