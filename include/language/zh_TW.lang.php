...
「5. 在應用程式的動作菜單中按一下「匯入」選項，並選取文件上載」   ',
    ...
    'LBL_ACTION_CREATE_FAILURE' => "無法保存紀錄' => \n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "無法更新紀錄' => \n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => "無法解析服務器上的字段計算。",
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => "以下字段無效' => {{{fields}}}。",
    ...
    'LBL_RUNTIME_FILTER_LIMITATION' => '您需要至少選擇一個值。',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => '只有報告所有者可以編輯篩選器。',
    'LBL_REPORT_QUERY' => '查詢',
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Doc合併',
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => '查看您創建或共享的最新案例活動。',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = '已嵌入檔案';
    ...
    $app_strings['LBL_SHARED_WITH_ME'] = '已與我共享';
