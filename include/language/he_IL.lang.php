...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        ...
        'donut chart' => 'תרשים טבעת',
        'treemap chart' => 'תרשים Treemap',
        'bar chart' => 'תרשים עמודות אנכי',
        'group by chart' => 'תרשים עמודות אנכי מקובץ',
        'horizontal bar chart' => 'תרשים עמודות אופקי',
        'horizontal group by chart' => 'תרשים עמודות אופקי מקובץ',
        'line chart' => 'תרשים קו',
...
$app_strings = array (
  ...
  שנה את הערך בבקשה.",
    ...
    'LBL_RELATED_RECORDS' => 'מודול {{module}} קשור',
...
פעולה זו תגרום לניתוק מיידי שלך מהמערכת ויהיה עליך לבצע אימות באמצעות אפליקציית האימות בפעם הבאה שתיכנס.',
  ...
  'ERR_FILE_NOT_FOUND' => 'שגיאה: לא מצליח לטעון קובץ {0}.  בדוק הרשאות בשרת שלך.',
    ...
    'LBL_ACTION_CREATE_FAILURE' => "כשל בשמירת הרשומה => \n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "כשל בעדכון הרשומה => \n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => "כשל בפענוח חישובי השדות בשרת.",
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => "השדות הבאים אינם חוקיים => {{{fields}}}.",
    ...
    'LBL_RUNTIME_FILTER_LIMITATION' => 'עליך לבחור בערך אחד לפחות.',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => 'רק בעלי הדוח יכול לערוך את המסננים.',
...
// Omnichannel
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'הצג את פעילות האירוע האחרונה שיצרת או ששותפה איתך.',
