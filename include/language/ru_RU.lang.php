...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        ...
        'treemap chart' => 'Древовидная диаграмма',
        ...
        'horizontal group by chart' => 'Горизонтальная сгруппированная гистограмма',
...
Выполнение этого действия приведет к немедленному выходу из системы, и вам нужно будет пройти проверку подлинности с помощью приложения для проверки подлинности при следующем входе в систему.',
  ...
  'ERR_FILE_NOT_FOUND' => 'Ошибка: Файл не был загружен {0}. Пожалуйста, проверьте системные и серверные права.',
    ...
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Вам необходимо выбрать минимум одно значение.',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => 'Только владелец отчета может редактировать фильтры.',
...
// Omnichannel
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY' => 'Моя деятельность',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'Просмотрите последние действия по обращению, которое вы создали или которым с вами поделились.',
