...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        ...
        'treemap chart' => '矩形树图表',
        'bar chart' => '垂直柱图表',
        'group by chart' => '垂直柱分组图表',
        'horizontal bar chart' => '水平柱图表',
        'horizontal group by chart' => '水平柱分组图表',
        'line chart' => '线状图表',
        'funnel chart' => '漏斗图',
    ),
...
请在设备设置中设置 {{{biometryType}}}。设置后，在“主菜单” > “设置”中为 {{{brandName}}} 启用
 {{{biometryType}}}。",
    ...
    'LBL_RUNTIME_FILTER_LIMITATION' => '您需要至少选择一个值。',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => '只有报告所有者可以编辑筛选器。',
    'LBL_REPORT_QUERY' => '查询',
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Doc合并',
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => '查看您创建或共享的最新案例活动。',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = '嵌入的文件';
    ...
    $app_strings['LBL_SHARED_WITH_ME'] = '与我分享';
