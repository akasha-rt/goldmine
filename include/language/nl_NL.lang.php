...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_types' => array (
        ...
        'donut chart' => 'Cirkeldiagram',
        'treemap chart' => 'Boomdiagram',
        'bar chart' => 'Verticale staafdiagram',
        'group by chart' => 'Verticale staafdiagram in groepen',
        'horizontal bar chart' => 'Horizontale staafdiagram',
        'horizontal group by chart' => 'Horizontale staafdiagram in groepen',
...
href="http://university.sugarcrm.com/" target="_blank">Kom meer te weten over Sugar</a><p class="details">Een uitgebreide bibliotheek van eLearning, live- en virtuele klaslokaaltraining, webinars en video&#39;s.</p></div></li><li class="resource"><a href="http://support.sugarcrm.com/" target="_blank"><span class="label label-module label-module-md pull-left red"><i class="fa fa-2x fa-question-circle"></i></span></a><div class="resource-info"><a href="http://support.sugarcrm.com/" target="_blank">Ontvang hulp</a><p class="details">Hulp nodig, een speciale vraag of heeft u suggesties om Sugar te verbeteren?</p></div></li></ul> ',
    ...
    'LBL_ACTION_CREATE_FAILURE' => "Opslaan volgende record mislukt => \n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Bijwerken volgende record mislukt => \n {{{reason}}}",
    ...
    'LBL_ERROR_IMAGE_NO_EXIF' => "Error' => EXIF-gegevens ontbreken in HEIC-bestand",
    'LBL_ERROR_IMAGE_TOO_BIG' => "Error' => Resolutie afbeelding te hoog",
    'LBL_ERROR_IMAGE_CANNOT_PROCESS' => "Error' => Kan de afbeelding niet verwerken",
    'LBL_ERROR_IMAGE_CANVAS_FAILED' => "Error' => Afbeelding renderen naar canvas mislukt",
    'LBL_ERROR_IMAGE_LOAD_FAILED' => "Error' => Bestand als afbeelding laden mislukt",
    ...
    'LBL_EDIT_FILTERS' => 'Filters bewerken',
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => 'Alleen de rapporteigenaar kan filters bewerken.',
...
// Omnichannel
    ...
    'LBL_KIOSK_MY_PROFILE_UPDATE_SUCCESS'=> 'Uw profiel is bijgewerkt.',
    'LBL_KIOSK_NAME' => 'Naam',
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY' => 'Mijn activiteiten',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'Bekijk de laatste case-activiteit die u hebt gemaakt of waarmee u bent gedeeld.',
