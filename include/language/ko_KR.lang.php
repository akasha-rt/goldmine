...
이 작업을 수행하면 즉시 로그아웃되며 다음에 로그인할 때 인증 앱을 사용하여 인증해야 합니다.',
  ...
  'ERR_FILE_NOT_FOUND' => '오류:파일을 전송하지 못했습니다. 시스템과 웹서버 허용을 확인하십시오.',
    ...
    'LBL_ACTION_CREATE_FAILURE' => "레코드를 저장하지 못했습니다' =>\n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "레코드를 업데이트하지 못했습니다' =>\n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => "서버에서 필드 계산을 해결하지 못했습니다.",
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => "다음 필드는 유효하지 않습니다' => {{{fields}}}.",
    ...
    'LBL_EDIT_REPORT_FILTERS_LIMITATION' => '보고서 소유자만 필터를 편집할 수 있습니다.',
    'LBL_REPORT_QUERY' => '문의',
...
// Omnichannel
    ...
    'LBL_KIOSK_MY_PROFILE_UPDATE_SUCCESS'=> '프로필 업데이트가 완료되었습니다.',
    'LBL_KIOSK_NAME' => '이름',
    ...
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => '생성했거나 공유받은 최신 사례 활동을 표시합니다.',
