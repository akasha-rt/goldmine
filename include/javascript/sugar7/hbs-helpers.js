...
(function(app) {
    app.events.on("app:init", function() {
        ...
        Handlebars.registerHelper('reportField', function(view, options) {
            ...
            if (_.isEmpty(model.get('id')) && this.link) {
            ...
            if (this.type === 'currency') {
                ...
                this.skip_preferred_conversion = true;
            }
            ...
            if (html) {
                if (field.type === 'enum') {
                    if (_.has(this, 'options')) {
                        field.items = app.lang.getAppListStrings(this.options);
                    } else if (_.has(this, 'function') && !_.isUndefined(view.data.functionOptions) &&
                        !_.isUndefined(view.data.functionOptions[this.function])) {
                        field.items = view.data.functionOptions[this.function];
                    }
                }
                field.render();
