    ...
    app.events.on("app:init", function() {
        ...
        app.utils = _.extend(app.utils, {
            ...
            reports: {
                 ...
                 * @return {boolean}
                 */
                hasAccessToAllReport: function(model) {
                    if (!_.isObject(model)) {
                        return true;
                    }
                    ...
                    if (!app.acl.hasAccess('view', reportDef.module)) {
                        hasAccess = false;
                    ...
                    _.each(fields, function checkACL(fieldData) {
                        ...
                        const accessToField = app.acl.hasAccessToModel('view', app.data.createBean(module), fieldName);
                        const accessToModule = app.acl.hasAccess('view', module);
