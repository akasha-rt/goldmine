...
class HintAccountset extends \Basic
{
    ...
    public function create_tables()
    {
        ...
        try {
            ...
            $this->handleHintInstallationFailure($e->getMessage());
        }
    }

    /*
     * Invoked when a Hint installation fails.
     */
    private function handleHintInstallationFailure($errorString)
    {
        $error = sprintf('Hint %s failed: %s. Please try installing again and perform a resync in the admin module.', $action, $errorString);
