...
(function(app) {
    ...
    function _getSpecificLayoutPosition(path, layout) {
        const component = path._components;
        for (var i = 0; i < component.length; i++) {
            if (component[i].label === layout) {
                return i;
            }
        }
        return -1;
     ...
     * viz. Ankara.
     *
     * @returns {View.Layout/undefined} A hint-preview layout or undefined if not found.
     */
    ...
    /**
     * _editStyles(): will try to display hidden Tabs after non Hint SubModules are clicked.
    ...
    /**
     * _editStylesUndo(): will try to hide Tabs after non Hint SubModules are clicked.
    ...
    /**
     * _removeExtraStyles(): It hides the extra tabs created by records.php for the previous versions of SUGAR.
     * The classNames are unique for the Tabbable and nav-tabs components.
     */
