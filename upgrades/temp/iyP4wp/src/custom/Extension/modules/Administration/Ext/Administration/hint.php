...
if (ConfigurationManager::shouldShowCustomUninstall()) {
    $admin_option_defs['Administration']['hint_uninstall'] = [
        'Administration',
        'icon' => 'sicon-trash',
        'LBL_HINT_UNINSTALL',
        'LBL_HINT_UNINSTALL_DESCRIPTION',
        'javascript:void(parent.SUGAR.App.router.navigate("hint/uninstall", {trigger: true}));',
    ];
}
$admin_group_header[] = [
