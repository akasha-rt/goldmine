...
class ViewdefsParser
{
    ...
    public static function updateNameToDropDown($fieldSet) {
        $fieldSet['name'] = 'name';
        $fieldSet['type'] = 'hint-accounts-search-dropdown';
        return $fieldSet;
    }

    public static function updateAvatarForAccounts($fieldSet) {
        $fieldSet['name'] = 'hint_account_pic_c';
        $fieldSet['type'] = 'hint-accounts-logo';
        $fieldSet['readonly'] = true;
        $fieldSet['dismiss_label'] = true;
        $fieldSet['white_list'] = true;
        return $fieldSet;
    }
    ...
    public static function updateAvatarForContactsAndLeads($fieldSet) {
        $fieldSet['name'] = 'picture';
        $fieldSet['type'] = 'hint-contacts-photo';
        $fieldSet['readonly'] = false;
        $fieldSet['dismiss_label'] = true;
        $fieldSet['white_list'] = true;
        $fieldSet['related_fields'][] = 'hint_contact_pic_c';
        return $fieldSet;
    }
    ...
    public static function setAccountFields(&$allPanels, $pkey, $fkey) {
        if (is_array($allPanels[$pkey]['fields'][$fkey])) {
            $fieldSet = $allPanels[$pkey]['fields'][$fkey];
            $fieldToTest = $fieldSet['name'];
            switch($fieldToTest){
                case 'name':
                    $allPanels[$pkey]['fields'][$fkey] = ViewdefsParser::updateNameToDropDown($fieldSet);
                    break;
                case 'picture':
                    $allPanels[$pkey]['fields'][$fkey] = ViewdefsParser::updateAvatarForAccounts($fieldSet);
                    break;
                default:
                    break;
            }
    ...
    public static function setContactsAndLeadsFields(&$allPanels, $pkey, $fkey, $field) {
        ...
        switch($fieldToTest){
            case 'email':
                ...
                break;
            case 'picture':
                $allPanels[$pkey]['fields'][$fkey] = ViewdefsParser::updateAvatarForContactsAndLeads($fieldType);
                break;
            default:
                break;
        }
