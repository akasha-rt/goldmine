 ...
 * PLACE ANY CUSTOMIZATIONS IN EAC_MarketingEmail
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class EAC_MarketingEmail_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'EAC_MarketingEmail';
    public $object_name = 'EAC_MarketingEmail';
    public $table_name = 'eac_marketingemail';
