 ...
 * PLACE ANY CUSTOMIZATIONS IN EAC_CompanyEmail
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class EAC_CompanyEmail_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'EAC_CompanyEmail';
    public $object_name = 'EAC_CompanyEmail';
    public $table_name = 'eac_companyemail';
