 ...
 * PLACE ANY CUSTOMIZATIONS IN DIM_DistributorContacts
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class DIM_DistributorContacts_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'DIM_DistributorContacts';
    public $object_name = 'DIM_DistributorContacts';
    public $table_name = 'dim_distributorcontacts';
