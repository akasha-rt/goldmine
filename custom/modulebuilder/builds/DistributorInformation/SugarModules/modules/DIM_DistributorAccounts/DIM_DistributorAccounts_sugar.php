 ...
 * PLACE ANY CUSTOMIZATIONS IN DIM_DistributorAccounts
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class DIM_DistributorAccounts_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'DIM_DistributorAccounts';
    public $object_name = 'DIM_DistributorAccounts';
    public $table_name = 'dim_distributoraccounts';
    ...
    public $twitter;
    public $googleplus;
    public $dim_distributoraccounts_type;
    public $industry;
