...
({
    ...
    _initEvents: function(){
        this.addProductWhenComingFromQote();
    },
    ...
    addProductWhenComingFromQote:function (){
        this._reloadPage();
        ...
        if(splittedURL.length==2){
            ...
            if(productDATA[0]=='product_number_id'){
                ...
                this._fetchRecordT(product_number_id, {
                    success: _.bind(this._sendItemToRecordT, this),
    ...
    _sendItemToRecordT: function(data) {
        ...
        app.controller.context.trigger('view71:productCatalogDashlet:add', data);
    },
